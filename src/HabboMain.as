   ...
   public class HabboMain extends Sprite
   {
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1200,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1200,error);
            Core.dispose();
         }
      }
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            Habbo.reportCrash("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_365,null);
         }
      }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.reportCrash("Download external configuration document is null!",Core.const_365,null);
         }
         if(this.var_23)
         {
         ...
         {
            Habbo.reportCrash("Core vanished while downloading config document!",Core.const_365,null);
         }
      }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_985 + this.var_23.getNumberOfFilesLoaded() / _loc11_ * const_985;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
