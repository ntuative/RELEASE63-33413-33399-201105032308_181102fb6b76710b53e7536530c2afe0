package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_404:Dictionary;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            this.var_573 = null;
            this.var_474 = null;
            for(_loc1_ in this.var_404)
            {
               ISkinTemplate(this.var_404[_loc1_]).dispose();
               delete this.var_404[_loc1_];
            }
            this.var_404 = null;
      ...
      {
         var _loc3_:ISkinTemplate = this.var_404[param2];
         if(_loc3_ == null)
         {
      ...
      public function removeLayout(param1:ISkinLayout) : ISkinLayout
      {
         var _loc2_:* = null;
         var _loc3_:* = 0;
         param1 = this.var_404[param1.name];
         if(param1 != null)
         {
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            ...
            delete this.var_404[param1.name];
         }
         return param1;
      }
   }
