package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_108:String = "com.sulake.habbo.roomevents.userdefinedroomevents.common";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_401 = SkinLayoutEntity.const_478;
                  break;
               case "move":
                  _loc5_.var_401 = SkinLayoutEntity.const_339;
                  break;
               case "strech":
                  _loc5_.var_401 = SkinLayoutEntity.const_638;
                  break;
               case "tiled":
                  _loc5_.var_401 = SkinLayoutEntity.const_326;
                  break;
               case "center":
                  _loc5_.var_401 = SkinLayoutEntity.const_1212;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_400 = SkinLayoutEntity.const_478;
                  break;
               case "move":
                  _loc5_.var_400 = SkinLayoutEntity.const_339;
                  break;
               case "strech":
                  _loc5_.var_400 = SkinLayoutEntity.const_638;
                  break;
               case "tiled":
                  _loc5_.var_400 = SkinLayoutEntity.const_326;
                  break;
               case "center":
                  _loc5_.var_400 = SkinLayoutEntity.const_1212;
            }
         }
