package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1781:uint = 0;
      
      public static const const_868:uint = 1;
      
      public static const const_1187:uint = 2;
      
      public static const const_817:uint = 4;
      
      public static const const_1752:uint = 8;
      
      public static const const_1723:uint = 16;
      
      public static const const_2004:uint = 64;
      
      public static const const_2099:uint = 128;
      
      public static const const_1085:uint = 256;
         ...
         if(this.var_879)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2149,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2149,16777215);
                  }
                  var_336 += bitmap.width * bitmap.height * 4;
               }
