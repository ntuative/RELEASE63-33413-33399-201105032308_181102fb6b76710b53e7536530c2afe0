package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_989:uint = 8;
      
      private static const const_1332:String = "skin";
      
      private static const const_1331:String = "bitmap";
      
      private static const const_1330:String = "fill";
      
      private static const const_1334:String = "text";
      
      private static const const_1333:String = "label";
      
      private static const const_1335:String = "shape";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "HabboWindowManagerCom_habbo_window_layout_alert_xml";
      ...
      private var var_2216:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2217 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1653,this.var_2217);
         this.var_2216 = new Dictionary();
         this.var_2215 = new Dictionary();
         StateCodeTable.fillTables(this.var_2216,this.var_2215);
         this.var_410 = new Dictionary();
         this.var_410[const_1332] = BitmapSkinRenderer;
         this.var_410[const_1331] = BitmapDataRenderer;
         this.var_410[const_1330] = FillSkinRenderer;
         this.var_410[const_1334] = TextSkinRenderer;
         this.var_410[const_1333] = LabelRenderer;
         this.var_410[const_1335] = ShapeSkinRenderer;
         ...
         if(var_334 == null)
         {
            ...
            var_334.push(WindowState.const_93);
            ...
            var_334.push(WindowState.const_108);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2915 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1653[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_887[param1] = new Array(const_989);
         }
         this.var_887[param1][param2] = param3;
         if(this.var_888[param1] == null)
         {
            this.var_888[param1] = new Array(const_989);
         }
         this.var_888[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_887[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_119)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_888[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_119)
