package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_290 = param1;
         if(this.var_290 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_290)
         {
      ...
      {
         return this.var_293 == int.MIN_VALUE && this.var_291 == int.MAX_VALUE && this.var_292 == int.MIN_VALUE && this.var_290 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.height > this.var_290)
            {
               this._target.height = this.var_290;
            }
         }
