package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_502:Array;
      ...
      private static const const_1376:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_205],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_205] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_502.indexOf(_loc4_.name) == -1)
            {
               var_502.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1376) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1375) + 2,_loc5_.length);
            }
