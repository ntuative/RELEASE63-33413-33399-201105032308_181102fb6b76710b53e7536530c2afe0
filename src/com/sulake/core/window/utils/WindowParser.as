package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1984:String = "_INCLUDE";
      
      public static const const_1930:String = "_TEMP";
      
      private static const const_1501:String = "layout";
      
      private static const const_1067:String = "window";
      
      private static const const_1069:String = "variables";
      
      private static const const_1068:String = "filters";
      
      private static const const_462:String = "name";
      
      private static const const_1510:String = "style";
      
      private static const const_680:String = "params";
      
      private static const const_1504:String = "tags";
      ...
      private static const const_1512:String = "visible";
      
      private static const const_1511:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1255:String = "blend";
      
      private static const const_1502:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1509:String = "treshold";
      
      private static const const_1508:String = "children";
      
      private static const const_1513:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1505:String = "height_min";
      
      private static const const_1500:String = "height_max";
      
      private static const const_679:String = "true";
      
      private static const const_171:String = "0";
      
      private static const const_1507:String = "$";
      
      private static const const_1457:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1503:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1506:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1087:Dictionary;
      
      protected var var_1621:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1348,this.var_1349);
         this.var_1087 = new Dictionary();
         this.var_1621 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1087,this.var_1621);
         this.var_2148 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1506,const_50);
         return param1.replace(const_1503,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1621)
            {
               delete this.var_1621[_loc1_];
            }
            this.var_2148.dispose();
            this.var_2148 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         {
            _loc8_ = param1.child(const_1069);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1068).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1067);
         ...
         if(param1.localName() == const_1067)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1510,variables,style));
         params = uint(this.parseAttribute(xml,const_680,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1504,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1512,variables,visible.toString()) == const_679;
         ...
         if(xml.child(const_680).length() > 0)
         {
            ...
            while(i < length)
            {
               ...
               if(this.var_1087[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_462)) + "\"!");
               }
               params |= this.var_1087[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1511,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1457);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1069)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1513,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1505,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1500,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_679;
         blend = Number(this.parseAttribute(xml,const_1255,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1502,variables,window.clipping.toString()) == const_679;
         ...
         list = xml.child(const_1068).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
