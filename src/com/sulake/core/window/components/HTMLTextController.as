package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_1007:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1964:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1248 == param2)
         {
            return;
         }
         param1.var_1248 = param2;
         param1.var_1964 = null;
         if(param1.var_1248 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1248);
            param1.var_1964 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_818.indexOf(param1) > -1)
         {
            this.var_811 = param1;
         }
      }
      ...
      {
         return this.var_811 == LinkTarget.const_30 ? defaultLinkTarget : this.var_811;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1964;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1308)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_787,this.var_811,PropertyStruct.const_55,true,PropertyDefaults.const_818));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_787)
            {
