package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
      ...
      {
         method_1(WindowState.const_53,param1);
      }
            ...
            if(_parent)
            {
               if(!(_parent is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc4_ = WindowEvent.allocate(WindowEvent.const_308,this,null);
      ...
      public function select() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_354,this,null);
         ...
         _loc1_.recycle();
         method_1(WindowState.const_53,true);
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_605,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         method_1(WindowState.const_53,false);
