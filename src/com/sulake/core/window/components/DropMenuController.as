package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_250.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_354,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_179 == null || this.var_179.disposed)
         {
            this.var_179 = context.create(name + "::submenu","",WindowType.const_488,var_77,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_250.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_898 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_898)
         {
            if(this.open())
            {
               if(this.var_250.length)
               {
                  this.populateMenuItemContainer(this.var_250,this.getSubMenu(),this.subMenuEventProc);
                  this.var_898 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_898 = false;
            this.getTitleLabel().text = this.var_601 < this.var_250.length && this.var_601 > -1 ? this.var_250[this.var_601] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_611,var_77,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_385,var_77,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_601).method_1(WindowState.const_53,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_729)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1138:
            case WindowMouseEvent.const_52:
               ...
               break;
            case WindowTouchEvent.const_725:
      ...
      public function open() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1798,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1540,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_250[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_250.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_809,this.var_250,PropertyStruct.const_169,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_809)
            {
