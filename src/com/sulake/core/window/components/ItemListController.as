package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2140:Boolean = false;
      ...
      protected var var_2138:int = 0;
      
      protected var var_1336:Number;
      
      protected var var_1338:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_108 = 0;
         this.var_95 = 0;
         this._horizontal = param2 == WindowType.const_381;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_173 = var_478 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_385,WindowStyle.const_119,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_41,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_398,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_164,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_198,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1337;
      }
      ...
      {
         return new Rectangle(this.var_702 * this.maxScrollH,this.var_703 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_702)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_598,this,null);
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_398,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_164,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_198,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_42:
               this.var_2139 = _loc3_;
               this.var_2138 = _loc4_;
               this.var_1336 = 0;
               this.var_1338 = 0;
               this.var_1339 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_217:
               if(this.var_1339)
               {
                  this.var_1336 = this.var_2139 - _loc3_;
                  this.var_1338 = this.var_2138 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1338 != 0 && this.var_95 != 0)
                  {
                     this.scrollV += this.var_1338 / this.var_95;
                  }
                  this.var_2139 = _loc3_;
                  this.var_2138 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_204:
               if(this.var_1339)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1338);
                  }
                  this.var_1339 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1083 && !this.var_570 && this._container)
         {
            this.var_570 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_770)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_375,this._spacing,PropertyStruct.const_43,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1099);
         }
         if(this.var_1083 != PropertyDefaults.const_1312)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_861,this.var_1083,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1769);
         }
         if(this.var_473 != PropertyDefaults.const_1169)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_693,this.var_473,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1710);
         }
         if(this.var_1337 != PropertyDefaults.const_1088)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_908,this.var_1337,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1648);
         }
         if(this.var_704 != PropertyDefaults.const_1092)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_695,this.var_704,PropertyStruct.const_137,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1728);
         }
         if(this.var_701 != PropertyDefaults.const_1225)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_884,this.var_701,PropertyStruct.const_137,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1631);
         }
         return _loc1_;
      }
