package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1329:String = "_SELECTOR";
      
      private static const const_1328:String = "_CONTENT";
       
      
      protected var var_1077:ITabSelectorWindow;
      
      protected var var_2132:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1077 = findChildByTag(const_1329) as ITabSelectorWindow;
            if(this.var_1077 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2132 = findChildByTag(const_1328) as IWindowContainer;
         }
