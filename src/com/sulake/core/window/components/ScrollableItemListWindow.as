package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_432)
         {
            this.var_432.removeEventListener(WindowEvent.const_269,this.scrollBarEventProc);
            this.var_432.removeEventListener(WindowEvent.const_207,this.scrollBarEventProc);
            this.var_432 = null;
         }
         if(this.var_1167)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_432)
         {
            ...
            if(this.var_432)
            {
               this.var_432.addEventListener(WindowEvent.const_269,this.scrollBarEventProc);
               this.var_432.addEventListener(WindowEvent.const_207,this.scrollBarEventProc);
            }
         }
         return this.var_432;
      }
