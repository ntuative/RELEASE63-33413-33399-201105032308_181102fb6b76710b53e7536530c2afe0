package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_394:Object = null;
      ...
      {
         return this.var_394 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_449);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_394 != null)
            {
               _loc1_.textColor = uint(this.var_394);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_449 != param1.name)
         {
            this.var_449 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2878 = _loc2_.textWidth;
         this.var_2877 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_394 != _loc2_.color : this.var_394 != null && this.var_394 != PropertyDefaults.const_805) ? new PropertyStruct(PropertyDefaults.const_439,this.var_394,PropertyStruct.const_165,true) : PropertyDefaults.const_1313);
         if(this.var_42)
         {
            if(this.var_42.left != PropertyDefaults.const_931)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_274,this.var_42.left,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_578);
            }
            if(this.var_42.top != PropertyDefaults.const_955)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,this.var_42.top,PropertyStruct.const_43,true));
            }
            else
            {
            ...
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_267,this.var_42.right,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_562);
            }
            if(this.var_42.bottom != PropertyDefaults.const_781)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_295,this.var_42.bottom,PropertyStruct.const_43,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_439:
                  this.var_394 = _loc2_.value as uint;
                  break;
