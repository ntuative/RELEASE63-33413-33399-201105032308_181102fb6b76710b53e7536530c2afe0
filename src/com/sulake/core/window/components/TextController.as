package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      private var var_449:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_449,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_449 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_449,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_888 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_449);
      }
      ...
      {
         return new Rectangle(this.var_874 * this.maxScrollH,this.var_577 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_449);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_708,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1119));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1235 ? new PropertyStruct(PropertyDefaults.const_923,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1250) : PropertyDefaults.const_1757);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1090 ? new PropertyStruct(PropertyDefaults.const_1135,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1295) : PropertyDefaults.const_1542);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_805) ? new PropertyStruct(PropertyDefaults.const_439,this._field.textColor,PropertyStruct.const_165,true) : PropertyDefaults.const_1313);
         _loc1_.push(this.var_449 != TextStyleManager.const_205 ? new PropertyStruct(PropertyDefaults.const_419,this.var_449,PropertyStruct.const_55,true,PropertyDefaults.const_719) : PropertyDefaults.const_1178);
         _loc1_.push(this.var_42.left != PropertyDefaults.const_931 ? new PropertyStruct(PropertyDefaults.const_274,this.var_42.left,PropertyStruct.const_43,true) : PropertyDefaults.const_578);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_955 ? new PropertyStruct(PropertyDefaults.const_294,this.var_42.top,PropertyStruct.const_43,true) : PropertyDefaults.const_476);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_804 ? new PropertyStruct(PropertyDefaults.const_267,this.var_42.right,PropertyStruct.const_43,true) : PropertyDefaults.const_562);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_781 ? new PropertyStruct(PropertyDefaults.const_295,this.var_42.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_589);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1111 ? new PropertyStruct(PropertyDefaults.const_712,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1731);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_137,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_137,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_137,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
