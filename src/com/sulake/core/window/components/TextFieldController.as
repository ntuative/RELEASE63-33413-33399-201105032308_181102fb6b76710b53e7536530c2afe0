package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1616:uint = 500;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1187,var_11);
         }
         return var_21;
      }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_438,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_328,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_917,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1820);
         _loc1_.push(this.var_1345 != PropertyDefaults.const_1283 ? new PropertyStruct(PropertyDefaults.const_957,this.var_1345,PropertyStruct.const_39,true) : PropertyDefaults.const_1538);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1294 ? new PropertyStruct(PropertyDefaults.const_854,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1541);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1113 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1796);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_957:
                  this.var_1345 = _loc2_.value as Boolean;
                  if(this.var_1345)
                  {
               ...
               case PropertyDefaults.const_917:
                  ...
                  break;
               case PropertyDefaults.const_1140:
