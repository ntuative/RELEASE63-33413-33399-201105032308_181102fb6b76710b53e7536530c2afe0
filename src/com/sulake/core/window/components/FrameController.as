package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1447:String = "_TITLE";
      
      private static const const_1449:String = "_HEADER";
      
      private static const const_1450:String = "_CONTENT";
      
      private static const const_1448:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1514:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1447) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1514 = findChildByTag(const_1449) as IHeaderWindow;
            if(!this.var_1514)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_194 = findChildByTag(const_1450) as IWindowContainer;
            if(!this.var_194)
            {
      ...
      {
         return findChildByTag(const_1448) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1318,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1082 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_352,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_274,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_294,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_267,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_295,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
