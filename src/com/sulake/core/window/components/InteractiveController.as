package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_620)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_217)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_620)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_856,param1.toolTipCaption,PropertyStruct.const_55,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1599);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1156)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_874,param1.toolTipDelay,PropertyStruct.const_258,true));
         }
         else
         {
