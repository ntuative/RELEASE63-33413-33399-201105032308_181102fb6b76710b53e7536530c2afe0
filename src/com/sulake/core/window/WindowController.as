package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1318:String = "_COLORIZE";
      
      protected static const const_1319:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1038:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            ...
            var_479 = _loc13_.var_2915;
            if(var_478 != _loc13_.background)
            {
      ...
      {
         var_478 = param1;
         var_241 = !!var_478 ? uint(var_241 | var_578) : uint(var_241 & 16777215);
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_241 = !!var_478 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      {
         var_578 = param1 << 24;
         var_241 = !!var_478 ? uint(var_578 | var_241) : uint(16777215 & var_241);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1255);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_940);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_77)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1319) == -1)
               {
                  _loc4_.style = var_77;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_371 = this._parent.rectangle.clone();
               var_61.x = var_11.x;
               var_61.y = var_11.y;
               var_61.width = var_11.width;
               var_61.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_627,this,this._parent);
            ...
            else
            {
               this.var_371.x = 0;
               this.var_371.y = 0;
               this.var_371.width = 0;
               this.var_371.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1692,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_868,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_77,var_20,_context,var_11,null,this.var_706,this.properties,var_875.concat(),_id) as WindowController;
         _loc2_.var_479 = var_479;
         _loc2_.var_173 = this.var_173;
         _loc2_._debug = this._debug;
         _loc2_.var_371 = this.var_371.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2557 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_538)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1249,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_296,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_704))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               ...
               case WindowMouseEvent.const_52:
                  ...
                  {
                     this.method_1(WindowState.const_93,false);
                  }
               ...
               case WindowMouseEvent.const_25:
                  ...
                  {
                     this.method_1(WindowState.const_85,false);
                  }
                  if(testStateFlag(WindowState.const_93))
                  {
                     this.method_1(WindowState.const_93,false);
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  if(!testStateFlag(WindowState.const_85))
                  {
                     this.method_1(WindowState.const_85,true);
                  }
                  break;
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_820,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_209,WindowParam.const_182))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_222,WindowParam.const_183))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_20 = _loc7_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_164,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_296:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1136);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1715,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_198,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_489:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1154,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_308,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_820:
                  this._parent.getRegionProperties(null,this.var_371);
                  this.updateScaleRelativeToParent();
                  break;
         ...
         if(this.var_173 && var_479 > 0)
         {
            if(!testParamFlag(WindowParam.const_34))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1038,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1038,param3,param1)) : false;
            }
         }
      ...
      public function method_1(param1:uint, param2:Boolean = true) : void
      {
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_77 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1319) == -1)
               {
                  _loc6_.style = var_77;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_141,WindowParam.const_182);
         ...
         if(_loc1_ || _loc2_)
         {
            ...
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_371.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_371.height;
               _loc5_ = uint(var_20 & 0);
      ...
      {
         if(_state == WindowState.const_496)
         {
            return true;
         }
         _state = WindowState.const_496;
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_73,true);
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1652,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_73,false);
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_90,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_489,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_90,false);
      ...
      public function lock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_73,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1833,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_84,false);
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_771,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_84,true);
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_88,true);
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.recycle();
         this.method_1(WindowState.const_88,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1774,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1215 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1215 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_398,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
