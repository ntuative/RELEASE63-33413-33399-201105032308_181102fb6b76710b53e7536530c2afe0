package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1839:uint = 4;
      
      protected static const const_1837:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1783:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1217:Boolean = false;
      
      public static const const_1603:int = 2;
      
      private static var var_919:Array = new Array();
      ...
      protected var var_607:Class;
      
      protected var var_471:uint = 0;
      
      protected var _name:String;
      
      protected var var_1082:Boolean = false;
      ...
      protected var var_2923:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1217)
         {
            ...
            while(var_733.length < const_1603 && false)
            {
               _loc1_ = var_919.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1082 ? uint(this.var_1335 - this.var_2134) : uint(getTimer() - this.var_2134);
      }
      ...
      {
         if(this.var_1081 && !_disposed)
         {
            this.var_1081 = false;
            if(!this.var_1082 && this.var_239)
            {
               this.var_1335 = -1;
               this.var_2134 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1082 && !_disposed && this.var_1334 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_239,const_1783 - this.var_1334);
            if(this.var_2923)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_471 = LibraryLoader.name_4;
         ...
         if(this.var_471 == LibraryLoader.const_1837)
         {
         ...
         if(this.var_471 == LibraryLoader.name_4)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_607 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_607.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
