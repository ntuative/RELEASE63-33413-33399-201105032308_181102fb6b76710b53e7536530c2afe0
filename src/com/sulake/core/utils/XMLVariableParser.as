package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_137:String = "Number";
      
      public static const const_1806:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1729:String = "bool";
      
      public static const const_55:String = "String";
      
      public static const const_251:String = "Point";
      
      public static const const_240:String = "Rectangle";
      
      public static const const_169:String = "Array";
      
      public static const const_239:String = "Map";
      
      private static const const_673:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_672:String = "value";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_673);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_673));
         }
         else
         {
            _loc4_ = param1.child(const_673)[0];
         }
         ...
         _loc7_ = param1.attribute(const_672);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_672));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_672)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_239 || _loc5_ == const_169)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_165:
               return uint(param1);
            case const_169:
               return param1.split(const_1457);
            default:
