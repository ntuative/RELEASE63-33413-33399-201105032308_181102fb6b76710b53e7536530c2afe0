package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_538:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_538 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_107 is BitmapDataAsset)
         {
            ...
            this.var_1566 = BitmapDataAsset(this.var_107).var_1566;
            this.var_1565 = BitmapDataAsset(this.var_107).var_1565;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1566 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1565 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
