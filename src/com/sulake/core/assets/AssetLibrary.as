package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_782:String = "AssetLibraryLoaded";
      
      public static const const_1797:String = "AssetLibraryUnloaded";
      
      public static const const_1716:String = "AssetLibraryLoadError";
      
      private static const const_462:String = "name";
      
      private static const const_1001:String = "asset";
      
      private static const const_1002:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1000:String = "library";
      
      private static var var_295:Dictionary;
      
      private static var var_1720:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_606 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1000);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1001);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1002);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_606 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_606 == param1.url && this.var_911)
         {
            if(!this.var_912 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_607);
            }
            this.var_912 = param2;
      ...
      public function unload() : void
      {
         ...
         this.var_911 = false;
         this.var_606 = null;
         dispatchEvent(new Event(AssetLibrary.const_1797));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_913[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1084,this.assetLoadEventHandler);
      ...
      {
         return this.var_153[param1] != null || (this.var_607 != null ? this.var_607[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1720.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_423[param1]);
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_607 = _loc2_.resource;
         this.var_606 = _loc2_.url;
         if(this.var_912)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_607);
         }
         this.var_911 = true;
         dispatchEvent(new Event(AssetLibrary.const_782));
         dispatchEvent(new Event(AssetLibrary.const_1162));
         if(this.var_912)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1716));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1000);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1001);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_462).toString() == param1)
               {
                  ...
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_606 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_607[param1]);
                  _loc6_ = _loc3_.child(const_1002);
                  if(_loc6_.length())
                  {
