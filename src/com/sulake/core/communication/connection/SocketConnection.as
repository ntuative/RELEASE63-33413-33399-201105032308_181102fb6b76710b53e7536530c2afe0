package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1787:int = 10000;
      ...
      private var var_548:ByteArray;
      
      private var var_1280:IEncryption;
      
      private var var_832:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_269 = param2;
         this.var_548 = new ByteArray();
         this.var_1281 = new MessageClassManager();
         this.var_80 = new Socket();
         this.var_214 = new Timer(const_1787,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc6_:ByteArray = this.var_832.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_549)
         {
            this.var_549.messageSent(String(_loc4_),_loc6_.toString());
         }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_832.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_832.decoder + "\n";
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_832.getMessages(this.var_548,receivedMessages);
         try
         {
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_548,offset);
               this.var_548 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_548.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_548.writeByte(this.var_80.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_214.stop();
         this.var_2011 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_831));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2011 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_831));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_831));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_831));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_831));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_831));
