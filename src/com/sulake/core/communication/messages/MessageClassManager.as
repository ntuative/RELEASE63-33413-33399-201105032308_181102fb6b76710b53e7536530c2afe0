package com.sulake.core.communication.messages
{
   ...
   public class MessageClassManager implements IMessageClassManager
   {
      ...
      private function registerMessageEvent(param1:int, param2:Class) : Boolean
      {
         ...
         {
            _loc5_ = _loc3_.@name;
            if(this.var_737[param1] == null)
            {
               this.var_737[param1] = [param2];
            }
            else
            {
               _loc6_ = this.var_737[param1];
               _loc6_.push(param2);
            }
            return true;
         }
      ...
      {
         var _loc2_:Array = this.var_737[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function toString() : String
      {
         ...
         for(_loc2_ in this.var_737)
         {
            _loc1_ += _loc2_ + " -> " + this.var_737[_loc2_] + "\n";
         }
         return _loc1_;
      }
   }
