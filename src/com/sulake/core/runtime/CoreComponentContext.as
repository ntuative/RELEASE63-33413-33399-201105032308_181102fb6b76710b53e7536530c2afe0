package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1394:String = "asset-libraries";
      
      private static const const_1396:String = "library";
      
      private static const const_1397:String = "service-libraries";
      
      private static const const_1392:String = "library";
      
      private static const const_1395:String = "component-libraries";
      
      private static const const_1393:String = "library";
      
      private static const const_1390:String = "error_data";
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1390,String(param4.getStackTrace()));
         }
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_365,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_365,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_365,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1691);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_771)
                  {
                     this.var_771.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_507 - this.var_364.length,this.var_507,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_204 ? 0 : this.var_1448 & 0;
         if(_loc3_ == Core.const_634)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_109)
         {
            ...
            {
               if(this.var_628[priority] < priority)
               {
                  ++this.var_628[priority];
                  skip = true;
               }
            }
            if(!skip)
