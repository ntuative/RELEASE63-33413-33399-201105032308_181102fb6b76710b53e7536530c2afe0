package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_2001:IMessageEvent;
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         this.var_2001 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2002 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1549);
         this._connection.addMessageEvent(this.var_2001);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               ...
               this._connection.removeMessageEvent(this.var_2001);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_798,RoomWidgetPlayListModificationMessage.const_765,RoomWidgetPlayListModificationMessage.const_872,RoomWidgetPlayListPlayStateMessage.const_740,RoomWidgetPlayListUserActionMessage.const_877];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_798:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_885,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_765:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_872:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_740:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_285:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_934,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_759,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_859));
               break;
