package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_891,RoomWidgetViralFurniMessage.const_823,RoomWidgetViralFurniMessage.const_190];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_891:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_602);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_823:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendViralFurniFoundMessage();
               }
               break;
            case RoomWidgetViralFurniMessage.const_190:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_586,RoomSessionViralFurniStatusEvent.const_522];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_586:
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_522:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
