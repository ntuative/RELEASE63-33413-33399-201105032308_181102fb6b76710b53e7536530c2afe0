package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_817:Point = null;
      ...
      {
         return [RoomWidgetChatMessage.const_546,RoomWidgetChatSelectAvatarMessage.const_915];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_546:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1219))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1219))
                              {
      ...
      {
         return [RoomSessionChatEvent.const_208];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_208:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_218)
                           {
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_218:
                                       _loc13_ = this.getPetImage(_loc16_);
                                       _loc12_ = uint(this.var_670.getValue(_loc16_));
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_99,null,this);
                                       if(_loc17_ != null)
                                       {
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1257 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1257);
            }
            if(this.var_817 == null)
            {
               ...
               this.var_541.y = 0;
               this.var_541.z = 0;
               this.var_817 = _loc4_.getScreenPoint(this.var_541);
               this.var_1257 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_541.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_817.x || _loc8_.y != this.var_817.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_817,_loc5_));
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_99,this);
            if(_loc5_ != null)
            {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1984.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1984.remove(param1);
         if(_loc3_ != null)
         {
