   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_231 != null)
         {
            ...
            this.var_231.events.addEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_231 != null)
         {
            ...
            this.var_231.events.removeEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
            this.var_231 = null;
         }
         this.var_1084 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_967);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_953);
         ...
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_732);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1693);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_421 || param1.type == RoomWidgetUserActionMessage.const_583 || param1.type == RoomWidgetUserActionMessage.const_495)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectMessage.const_967:
            ...
            case RoomWidgetUserActionMessage.const_622:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_743,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_614:
               ...
               break;
            case RoomWidgetUserActionMessage.const_953:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_833:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_732:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_253);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_253);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1198);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1194);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_727)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_383) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_383.length);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_218)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc12_.webID);
                  return null;
               }
               if(_loc12_.type == RoomObjectTypeEnum.const_144)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_484)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_595);
               }
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_133)
               {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_110)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_785);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_761;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_973;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1745);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_785);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_231 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_425,_loc2_,_loc3_,_loc4_));
         }
      }
