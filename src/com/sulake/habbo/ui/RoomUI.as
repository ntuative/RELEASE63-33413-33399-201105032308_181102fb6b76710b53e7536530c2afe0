package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1222:IRoomWidgetFactory;
      ...
      private var var_2058:IHabboAvatarEditor = null;
      
      private var _catalog:IHabboCatalog;
      
      private var var_327:IAdManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var _habboHelp:IHabboHelp;
      
      private var var_1051:IHabboModeration;
      ...
      private var var_1306:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1590 = RoomDesktop.const_482;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1222.release(new IIDHabboRoomWidget());
            this.var_1222 = null;
         }
         ...
         {
            this.var_1051.release(new IIDHabboModeration());
            this.var_1051 = null;
         }
         ...
         if(this.var_1306)
         {
            this.var_1306.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1306 = null;
         }
         this.var_2058 = null;
         ...
         if(this.var_326)
         {
            ...
            {
               _loc1_ = this.var_326.getKey(0) as String;
               _loc2_ = this.var_326.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1222 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2058 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_327 != null && this.var_327.events != null)
         {
            this.var_327.events.addEventListener(AdEvent.const_537,this.adEventHandler);
            this.var_327.events.addEventListener(AdEvent.const_521,this.adEventHandler);
            this.var_327.events.addEventListener(AdEvent.const_580,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1051 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1051);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_16)
         {
            ...
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_208,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionChatEvent.const_624,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionUserBadgesEvent.const_156,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionPresentEvent.const_309,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_502,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionPetPackageEvent.const_543,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_586,this.roomSessionEventHandler);
            this.var_16.events.addEventListener(RoomSessionViralFurniStatusEvent.const_522,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_871,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1142,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_1110,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_299,this.roomSessionDialogEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_876,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_750,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_223,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_890,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionErrorMessageEvent.const_720,this.roomSessionDialogEventHandler);
            this.var_16.events.addEventListener(RoomSessionQueueEvent.const_639,this.roomSessionEventHandler);
            ...
            this.var_16.events.addEventListener(RoomSessionDimmerPresetsEvent.const_532,this.roomSessionEventHandler);
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_87:
               this._toolbar.events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_314));
               break;
            case RoomSessionEvent.const_96:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_175,HabboToolbarIconEnum.ZOOM));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_175,HabboToolbarIconEnum.MEMENU));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_175,HabboToolbarIconEnum.INVENTORY));
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_259:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_871:
            ...
            case RoomSessionErrorMessageEvent.const_876:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_750:
      ...
      {
         this.var_1306 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_828,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_343,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_345,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_979,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_647,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_828)
         {
            if(this.var_16 != null)
            {
               this.var_16.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_623 || param1.type == RoomEngineEvent.const_582)
         {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_343:
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_415);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1590 != RoomDesktop.const_482)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_313,this.var_1590);
               }
               if(this.var_327 != null)
               {
                  this.var_327.showRoomAd();
               }
               _loc3_.createWidget(RoomWidgetEnum.const_519);
               _loc3_.createWidget(RoomWidgetEnum.const_515);
               break;
            case RoomEngineEvent.const_345:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_979:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1222;
         ...
         _loc3_.avatarEditor = this.var_2058;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_327;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this._habboHelp;
         _loc3_.moderation = this.var_1051;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1306;
         ...
         _loc3_.init();
         this.var_326.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_326.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_313);
      ...
      {
         return this.var_326.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_326.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
