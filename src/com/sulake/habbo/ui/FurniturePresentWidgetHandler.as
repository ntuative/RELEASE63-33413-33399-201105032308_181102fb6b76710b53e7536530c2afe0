package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_812,RoomWidgetPresentOpenMessage.const_190];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_812:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_253);
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_190:
      ...
      {
         return [RoomSessionPresentEvent.const_309];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_309:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_64:
                           if(_loc3_ != null && _loc3_.name == const_236)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_594,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                        ...
                        case ProductTypeEnum.const_344:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_542,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
