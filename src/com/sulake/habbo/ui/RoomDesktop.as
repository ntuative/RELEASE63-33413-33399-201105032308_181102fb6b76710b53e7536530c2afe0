package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1434:int = 1000;
      ...
      private var var_1222:IRoomWidgetFactory = null;
      ...
      private var var_2634:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_641,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_925,this.onRoomContentLoaded);
         }
      }
      ...
      public function set toolbar(param1:IHabboToolbar) : void
      {
         ...
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_534,this.onToolbarRepositionEvent);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         {
            this.var_210.toolbarSize = this._toolbar.size;
            this.var_210.toolbarOrientation = this._toolbar.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_798.length)
            {
               _loc6_ = this.var_798.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_641,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_925,this.onRoomContentLoaded);
         }
         ...
         {
            this._toolbar.events.removeEventListener(HabboToolbarEvent.const_534,this.onToolbarRepositionEvent);
         ...
         {
            this.var_482.reset();
            this.var_482.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_482 = null;
         }
         this.var_1917 = null;
      }
      ...
      public function init() : void
      {
         ...
         if(this.var_327 != null && this.var_31.state == RoomSessionEvent.const_242)
         {
            this.var_1915 = !this.var_327.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1222.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_210.addWidgetWindow(param1,_loc2_.mainWindow);
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_798.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc8_ = null;
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_796.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_796.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_797.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_797.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         ...
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_210.roomViewRect);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_796.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1222) == 1)
               {
                  _loc2_ = true;
                  if(this.var_367.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_777:
               ...
               if(this.var_1051 != null && _loc3_ == RoomObjectCategoryEnum.const_33)
               {
                  _loc7_ = this.var_31.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_144)
                  {
                     this.var_1051.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_174:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_846,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_954:
               if(!this.var_31.isRoomController && !this.var_367.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_152:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1181,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_609:
               ...
               break;
            case RoomEngineObjectEvent.const_647:
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_582:
               ...
               break;
            case RoomEngineEvent.const_623:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_742);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_748);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_769);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_31.roomId,this.var_31.roomCategory,RoomVariableEnum.const_899);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_147,this.canvasMouseHandler);
         _loc10_.addEventListener(WindowMouseEvent.const_217,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2634);
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         switch(_loc2_.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_147:
               _loc3_ = "null";
               break;
            ...
            case WindowMouseEvent.const_204:
               _loc3_ = "null";
               break;
            case WindowMouseEvent.const_217:
               _loc3_ = "null";
               break;
            default:
               return;
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1917 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_31.roomId,this.var_31.roomCategory,this.var_307[0],_loc2_.width,_loc2_.height);
         if(this.var_482 == null)
         {
            this.var_482 = new Timer(const_1434,1);
            this.var_482.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_482.reset();
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1917));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1916) / 1000);
            if(this._habboTracking != null)
            {
               if(param1)
               {
                  this._habboTracking.track("zoomEnded","HabboErrorVariableEnum",_loc3_);
               }
               else
               {
      ...
      {
         if(this.var_16 != null && this.var_31 != null && this.var_1915 && this._loadingComplete)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_647:
               ...
               this.var_232 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_431,WindowStyle.const_119,WindowParam.const_102) as IToolTipWindow;
               this.var_232.setParamFlag(WindowParam.const_31,false);
