package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_976,RoomWidgetEcotronBoxOpenMessage.const_930,RoomWidgetEcotronBoxOpenedMessage.const_1552];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_976:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_930:
