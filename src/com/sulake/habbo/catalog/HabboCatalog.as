package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_138:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_227:PurchaseConfirmationDialog;
      
      private var var_303:ChargeConfirmationDialog;
      ...
      private var var_2518:GiftWrappingConfiguration;
      
      private var var_1197:ClubGiftController;
      
      private var var_512:ClubBuyController;
      
      private var var_774:Map;
      
      private var var_1196:Boolean = false;
      
      private var var_966:IPurchasableOffer;
      
      private var var_1462:IDragAndDropDoneReceiver;
      
      private var var_65:PlacedObjectPurchaseData;
      
      private const const_1031:Point = new Point(100,20);
      ...
      private function reset() : void
      {
         ...
         {
            Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1662);
            return;
         }
         events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
         var _loc1_:Boolean = this.var_367.loadProductData(this);
         if(_loc1_)
         {
            this.init();
         }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_512.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var _loc2_:Array = this.var_774.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_106.getActivityPointsForType(Purse.const_195)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIcon();
            this.var_367.loadProductData(this);
         }
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1031;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1848 = param1.session.isPrivateRoom;
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_138 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1197 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_512 == null)
         {
            this.var_512 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_775 && this.var_775 != "")
         {
            this.var_366.method_2(this.var_775);
            this.var_775 = "";
            this.var_965 = -1;
         }
         else if(this.var_965 > -1)
         {
            this.var_366.openPageById(this.var_965,this.var_1846);
            this.var_965 = -1;
            this.var_1846 = -1;
            this.var_775 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2519 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1116);
         }
         this.var_2519 = false;
         if(this.var_303 != null)
         {
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2520 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1263);
         }
         this.var_2520 = false;
         if(this.var_303 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1197.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_138 != null)
         {
            this.var_138.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_138 != null)
         {
            this.var_138.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_138 != null)
         {
            this.var_138.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2518 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_138.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_303 == null)
         {
            this.var_303 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_303.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_774.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_774.add(_loc2_.productCode,_loc3_.slice());
      ...
      {
         if(!this.var_176.keyExists("catalog.drag_and_drop") || this.var_176.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1196 && param1.type == RoomEngineObjectEvent.const_176)
         {
            ...
            _loc3_ = this.var_966.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_65 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_966);
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_304,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_221);
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_200);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_176.getKey("image.library.catalogue.url");
