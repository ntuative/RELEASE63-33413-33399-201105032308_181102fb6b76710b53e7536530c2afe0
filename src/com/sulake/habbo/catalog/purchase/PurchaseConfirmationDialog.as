package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1878:uint = 4.294967295E9;
      
      private const const_1426:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1818 = _loc1_.stuffTypes;
            this.var_765 = _loc1_.boxTypes;
            this.var_764 = _loc1_.ribbonTypes;
            this.var_1178 = this.var_1818[0];
            this.var_360 = this.var_765[0];
            this.var_359 = this.var_764[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_359 < 0)
         {
            this.var_359 = this.var_764.length - 1;
         }
         if(this.var_359 > this.var_764.length - 1)
         {
            this.var_359 = 0;
         }
         if(this.var_360 < 0)
         {
            this.var_360 = this.var_765.length - 1;
         }
         if(this.var_360 > this.var_765.length - 1)
         {
            this.var_360 = 0;
         }
         var _loc1_:int = this.var_765[this.var_360] * 1000 + this.var_764[this.var_359];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_92.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1178,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1442 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1818;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1178);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_765[this.var_360]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_764[this.var_359]);
         this._catalog.purchaseProductAsGift(this.var_1444,this.var_92,this.var_1443,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1444,this.var_92.offerId,this.var_1443);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_626 == null)
         {
            this.var_626 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_626.procedure = this.suggestionsEventHandler;
         }
         if(this.var_258 == null || this.var_626 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_626.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1426;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1877) : uint(this.const_1878);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1178;
               }
            }
            _loc4_++;
         }
