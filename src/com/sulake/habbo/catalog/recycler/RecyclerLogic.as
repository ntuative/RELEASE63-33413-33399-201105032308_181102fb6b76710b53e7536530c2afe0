package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_990:int = 2;
      ...
      {
         return this.var_1693 != RecyclerStatusMessageEvent.const_1094;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_598 == const_452;
      }
      ...
      {
         this.var_598 = const_990;
         this.var_110 = new Array(const_225);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1693)
         {
            case RecyclerStatusMessageEvent.const_1618:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1094:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1624:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1167:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1572:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_110.length < const_225)
         {
            return false;
         }
         var _loc1_:int = 0;
