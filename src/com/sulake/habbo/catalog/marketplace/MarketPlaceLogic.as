package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_227:MarketplaceConfirmationDialog;
      ...
      private var var_2786:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_227)
         {
            this.var_227 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_227.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2783,this.var_2785,this.var_2466,this.var_2784);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_481)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2483 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      {
         if(param1.furniCategoryId != this.var_2595 || param1.furniTypeId != this.var_2591)
         {
            return;
         }
