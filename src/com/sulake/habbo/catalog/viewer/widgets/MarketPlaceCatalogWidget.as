package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2166:int = 40;
      
      private const const_2167:int = 10;
      
      private var var_810:Array;
      
      private var var_1522:MarketPlaceOfferData;
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_664)
         {
            ...
            this.var_664 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_664)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1882,_loc2_.length);
         if(!this.var_534)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1245 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1245));
            ++this.var_1245;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_664 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_664.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1881);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1522.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_59)
