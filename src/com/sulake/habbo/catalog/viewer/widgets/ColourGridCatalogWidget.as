package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_361:IItemGridWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_361 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         for each(_loc2_ in param1.colours)
         {
            this.var_952.push(_loc2_.slice());
         }
         _loc3_ = page.viewer.catalog.assets.getAssetByName(param1.backgroundAssetName) as BitmapDataAsset;
         this.var_627 = _loc3_.content as BitmapData;
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.colourAssetName) as BitmapDataAsset;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_952.length,this.var_361.numGridItems]);
         this.var_361.destroyGridItems();
         this.var_344 = null;
         for each(_loc1_ in this.var_952)
         {
            if(_loc1_.length > 0)
            {
               ...
               _loc2_.width = this.var_627.width;
               _loc2_.height = this.var_627.height;
               this.var_361.addGridItem(_loc2_);
               _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
               if(_loc3_ != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_627.width,this.var_627.height,true,0);
                  _loc3_.bitmap.copyPixels(this.var_627,this.var_627.rect,new Point(0,0));
               }
               _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
               if(_loc4_ != null)
               {
                  _loc4_.bitmap = new BitmapData(this.var_953.width,this.var_953.height,true,0);
                  _loc6_ = 255;
                  _loc7_ = 255;
                  _loc8_ = 255;
                  _loc9_ = null;
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_904.width,this.var_904.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_904,this.var_904.rect,new Point(0,0),null,null,true);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_361.getGridItemIndex(param1.target as IWindow);
