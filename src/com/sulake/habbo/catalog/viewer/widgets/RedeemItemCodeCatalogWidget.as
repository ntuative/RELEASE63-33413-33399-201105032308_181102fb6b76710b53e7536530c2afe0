package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_945.removeEventListener(WindowKeyboardEvent.const_187,this.windowKeyEventProcessor);
            this.var_945 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         if(this.var_945 != null)
         {
            this.var_945.addEventListener(WindowKeyboardEvent.const_187,this.windowKeyEventProcessor);
         }
         return true;
      }
