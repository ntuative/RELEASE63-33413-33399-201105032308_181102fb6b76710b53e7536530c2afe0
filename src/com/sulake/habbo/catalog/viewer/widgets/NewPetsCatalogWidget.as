package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2288 = _loc2_.localizationId;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_212 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1351 && _loc2_ < this.var_212.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_493,this.var_212[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_493,this.var_348),this.getRaceLocalizationKey(this.var_493,this.var_348));
            }
         }
         return this.getRaceLocalizationKey(this.var_493,this.var_348);
      }
