package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1896:ITextWindow;
      
      private var var_1894:ITextWindow;
      
      private var var_1893:ITextWindow;
      
      private var var_2959:ITextWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_862,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2605 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2606 = _loc2_.content as XML;
         }
         ...
         events.addEventListener(WidgetEvent.const_862,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_703:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2605) as IWindowContainer;
               break;
            case Offer.const_1277:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2606) as IWindowContainer;
               break;
            case Offer.const_1262:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2607) as IWindowContainer;
               break;
            default:
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _window.removeChild(this.var_983);
         ...
         this.var_1896 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1894 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1893 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2959 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_637 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_637 != null)
         {
            if(this.var_1489 != null)
            {
               this.var_637.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1489);
            }
            else
            {
               this.var_637.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1489);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1896 != null)
         {
            ...
            this.var_1896.caption = "${catalog.purchase.price.credits}";
         }
         ...
         if(this.var_1893 != null)
         {
            ...
            this.var_1893.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_1895 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_92 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_92,page.pageId,this.var_1895);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_92 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_92,page.pageId,this.var_1895,param1.enableBuyAsGift);
         }
      }
   }
}
