package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1601:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1059 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         this.var_2086 = new Point(this.var_86.x,this.var_86.y);
         this.var_561 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1601 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_2087 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1059.text = _loc4_;
         this.var_1320.text = _loc5_;
         this.var_1059.height = this.var_1059.textHeight + 5;
         this.var_1320.y = this.var_1059.y + this.var_1059.height;
         ...
         else
         {
            ...
            {
               case Offer.const_633:
                  _loc6_ = this.var_2087.clone();
                  if(this.var_561 != null)
                  {
                     this.var_561.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_561,this.var_1601,this.var_1630);
                     ...
                     case ProductTypeEnum.const_224:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_323,AvatarAction.const_571);
                              _loc16_.appendAction(AvatarAction.const_355,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2892)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2892 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_2086.x;
            this.var_86.y = this.var_2086.y;
            if(param3 != null)
            {
