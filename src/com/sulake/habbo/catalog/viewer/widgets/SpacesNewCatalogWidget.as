package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_452:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_452 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_452)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_452.numSelectables)
            {
               _loc3_ = this.var_452.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_101[this.var_556]);
      ...
      {
         var _loc2_:int = this.var_847[this.var_556];
         var _loc3_:Offer = this.var_215[this.var_556][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_579.numGridItems)
         {
            _loc2_ = this.var_215[this.var_556][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_847[this.var_556] = (this.var_215[this.var_556] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_847[0];
         var _loc2_:int = this.var_847[1];
         var _loc3_:int = this.var_847[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_380 || _loc1_.pricingModel == Offer.const_434))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_452.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_452.setSelected(this.var_452.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_215[this.var_556],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_847[this.var_556];
