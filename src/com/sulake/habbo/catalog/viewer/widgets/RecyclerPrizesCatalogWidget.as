package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_584 = this.recycler.getPrizeTable();
         ...
         this.var_1631 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_584.length > 0 && this.var_584[0].prizes.length > 0)
         {
            this.select(this.var_584[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      private function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_584[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1631) as IWindowContainer;
