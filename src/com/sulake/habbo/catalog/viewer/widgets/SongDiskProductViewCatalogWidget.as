package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         ...
         this.var_1230 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         ...
         this.var_1229 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1229 != null)
         {
            this.var_1229.visible = false;
         }
      ...
      override public function dispose() : void
      {
         ...
         {
            this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_216);
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this.forceNoFadeoutOnPlayingSong(HabboMusicPrioritiesEnum.const_216);
            this._soundManager.musicController.playSong(this.var_998,HabboMusicPrioritiesEnum.const_216,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_998 = parseInt(_loc2_.extraParam);
            if(this.var_1229 != null)
            {
               this.var_1229.visible = true;
            }
         }
         else
         {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1230.text = _loc8_;
            }
         }
         else if(this.var_1230 != null)
         {
            this.var_1230.text = "";
         }
         if(this.var_430 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_998);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_998);
         }
         return -1;
      }
