package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_215[this.var_556][this.var_847];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_556 = var_579.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_556];
         var _loc3_:Array = this.var_215[this.var_556] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_847 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_847] as Offer;
