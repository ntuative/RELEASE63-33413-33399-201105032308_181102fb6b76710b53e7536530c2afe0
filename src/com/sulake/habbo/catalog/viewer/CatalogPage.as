package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1835:String = "ctlg_";
      ...
      private var var_1128:ItemGridCatalogWidget;
      ...
      {
         var _loc2_:String = const_1835 + param1;
         ...
         this.var_1346 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1346) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1819:
               if(this.var_1128 == null)
               {
                  this.var_1128 = new ItemGridCatalogWidget(param1);
                  this.var_35.push(this.var_1128);
               }
               break;
