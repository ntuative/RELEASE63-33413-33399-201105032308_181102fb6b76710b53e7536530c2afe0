package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_992:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_251:IItemGrid;
      ...
      {
         this._view.getChildByName(const_992).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_992).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_85,MouseCursorType.const_831);
            (this._view as IInteractiveWindow).setMouseCursorForState(0 | 0,MouseCursorType.const_831);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_251.select(this);
            this.var_599 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_599 != null && this.var_599 == param2)
         {
            _loc3_ = this.var_251.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_599 = null;
            }
