package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2178:int = 0;
      
      private const const_1083:int = 1;
      ...
      private var var_825:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_454.add(FurniModel.const_47,new FurniGridView(this.var_67,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_454.add(FurniModel.const_49,new FurniGridView(this.var_67,FurniModel.const_49,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_454.getValue(this.var_455);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_67.getCategoryContent(this.var_455);
         if(!this.var_67.isListInited())
         {
            _loc2_ = this.const_1083;
         }
         ...
         if(this.var_2265 == _loc2_)
         {
            return;
         }
         this.var_2265 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_454.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_454.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_454.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_67.getGroupItemInIndex(_loc3_,this.var_455);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_825 && this.var_825.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
