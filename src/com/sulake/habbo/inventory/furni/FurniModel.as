package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1340:int = 1000;
      ...
      private var var_1684:Vector.<Array>;
      
      private var var_1683:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_593 = new Timer(const_1341,1);
         this.var_593.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2242 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_593.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_593.stop();
               this.var_593 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_47)
            {
               ...
               {
                  this.var_1684 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1684;
            }
            else
            {
               if(this.var_1683 == null)
               {
                  this.var_1683 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1683;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_894 == null)
         {
            this.var_894 = this._windowManager.buildFromXML(this.var_2242) as IWindowContainer;
         }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_594.add(const_47,new Array());
         this.var_594.add(const_49,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            for(; _loc9_ < _loc7_.length; _loc9_++)
            {
               ...
               if(_loc8_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_226)
                  {
                     _loc6_ = _loc8_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == CATEGORY_PETS)
            {
               ...
               {
                  this._controller.petsModel.switchToFurnitureCategory(_loc5_);
               }
            }
            else
            {
      ...
      {
         return getTimer() < this.var_2240 + const_1340;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_312;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_318 || _loc3_.category == FurniCategory.const_327 || _loc3_.category == FurniCategory.const_303)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_594.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_594.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_981)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
