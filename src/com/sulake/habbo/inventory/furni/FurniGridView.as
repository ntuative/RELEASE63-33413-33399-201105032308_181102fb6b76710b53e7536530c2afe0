package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_251:IItemGridWindow;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_251 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            this.var_251.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_251.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_251.autoArrangeItems = false;
            this.var_251.lock();
         }
         else
         {
            this.var_251.autoArrangeItems = true;
            this.var_251.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_67.toggleItemSelection(this._category,this.var_251.getGridItemIndex(param1.window));
            this.var_599 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_599 != null && this.var_599 == param2 && !this.var_67.isTradingOpen)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_147)
         {
