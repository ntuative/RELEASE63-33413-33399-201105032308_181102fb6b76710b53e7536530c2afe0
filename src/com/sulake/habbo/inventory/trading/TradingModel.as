package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1689:uint = 9;
      
      public static const const_201:uint = 0;
      
      public static const const_220:uint = 1;
      
      public static const const_442:uint = 2;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_56.updateItemList(this.var_758);
         this.var_56.updateItemList(this.var_1436);
      ...
      public function close() : void
      {
         if(this.var_717)
         {
            if(this._state != const_201 && this._state != const_268)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_759 + " OTHER: " + this.var_1172);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1150);
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_56.alertPopup(TradingView.const_1253);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_255.length < const_1689)
         {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_226)
            {
