package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private const const_1031:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this._toolbar != null && this.var_1185)
         {
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc3_.visible)
         {
            if(this.var_506 == param1)
            {
               if(param2)
               {
                  if(WindowToggle.isHiddenByOtherWindows(_loc3_,_loc3_.desktop))
                  {
                     _loc3_.activate();
                  }
                  else
         ...
         {
            if(this.var_506 != null && this.var_506 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_506 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this._toolbar != null && this.var_1185)
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1823);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_506 == InventoryCategory.const_148)
            {
               this.toggleCategoryView(InventoryCategory.const_148);
            }
            else if(this.var_506 == InventoryCategory.const_80)
            {
