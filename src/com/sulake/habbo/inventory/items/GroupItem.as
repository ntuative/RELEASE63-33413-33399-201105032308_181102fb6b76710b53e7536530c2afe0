package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2886:int;
      
      protected var var_1617:Boolean;
      
      protected var var_2135:Boolean;
      
      protected var var_2925:BitmapData;
      
      private const const_2120:int = 8947848;
      
      private const const_2119:int = 13421772;
      
      private const const_1851:Number = 1;
      
      private const const_1850:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2924 == FurniModel.const_47)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1478));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_981)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1850;
               _loc1_.blend = this.const_1850;
            }
            else
            {
         ...
         if(_loc5_)
         {
            if(this.var_2135 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2925;
               _loc5_.visible = true;
            }
            else
            {
