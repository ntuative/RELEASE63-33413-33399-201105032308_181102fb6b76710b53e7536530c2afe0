package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1321:uint = 1;
      ...
      private var var_1357:IEventDispatcher;
      
      private var var_1090:Boolean = false;
      
      private var var_1632:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this._windowRenderer = new WindowRenderer(this.var_880);
         ...
         this.var_267 = this.var_198[const_1321];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1632)
            {
               this.var_1632 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1632.profiler = _loc3_;
            this.var_1358 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1358);
            this.var_1356 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1356);
            this.var_1090 = true;
         }
      }
      ...
      {
         return this.var_198[param1].getDesktopWindow().getChildAt(this.var_267.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_399.length > 0)
         {
            this.var_1357.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_451 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1357.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_399.length > 0)
         {
            WindowContext.var_399.flush();
         }
         MouseCursorControl.change();
         this.var_1357.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1765,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1630,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1751,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_573,
            "style":WindowStyle.const_119,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
