package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2730 = new RoomThumbnailRenderer(param1);
         this.var_1227 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_193,this.var_124);
         if(this.var_124.ownerName != "" && this.var_124.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_193,!!this.var_124.event ? this.getEventCtg(this.var_124.categoryId) : this.getRoomCtg(this.var_124.categoryId));
         this.refreshRoomDesc(this.var_193,this.var_124);
         this.refreshExtraCont();
         this.refreshInfo(this.var_193,"trading_allowed",this.var_124.allowTrading);
         this.refreshInfo(this.var_193,"doormode_doorbell",this.var_124.doorMode == 1);
         this.refreshInfo(this.var_193,"doormode_password",this.var_124.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_193,this.var_124.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1227.refreshTags(_loc1_,this.var_124.tags);
         ...
         this.var_2730.refreshThumbnail(_loc1_,this.var_124.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_276,Tabs.const_265,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
