package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1097:TextFieldManager;
      ...
      private var var_1099:TextFieldManager;
      ...
      private var var_586:ICheckBoxWindow;
      ...
      {
         if(param1 != this.var_337 || this.var_1101 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1101 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1598)
         {
            this.var_716.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1628)
         {
            this.var_716.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1719)
         {
            this.var_1097.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1585)
         {
            ...
            this.setTagError(this.var_886,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1742)
         {
            ...
            this.setTagError(this.var_886,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1813)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_354,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_605,this.onDoorModePasswordUnselect);
         ...
         this.var_1097 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_885 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_886 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_884 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1099 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1100 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1103 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1096 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_586 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this._thumbnailContainer = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1102 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1104 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         ...
         this.var_1098 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1362 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1362.mouseThreshold = 0;
         this.var_1362.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1098.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         if(this.var_715)
         {
            ...
            this.var_1104.height = Util.getLowestPoint(this.var_1104) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1102.height = Util.getLowestPoint(this.var_1102) + 4;
         }
         this.var_1362.text = !!this.var_715 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1102.name,this.var_1104.name,this.var_1363.name,this.var_1638.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1097.setText(_loc1_.description);
         this.var_884.setText("");
         this.var_1099.setText("");
         ...
         this.setTag(this.var_885,_loc1_.tags[0]);
         this.setTag(this.var_886,_loc1_.tags[1]);
         if(this.var_1100)
         {
            if(_loc1_.allowPets)
            {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1097.getText();
         ...
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_131)
         {
            ...
            _loc9_ = this.var_1099.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_884.clearErrors();
               this.var_1099.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1100.isSelected;
         _loc2_.allowFoodConsume = this.var_1103.isSelected;
         _loc2_.allowWalkThrough = this.var_1096.isSelected;
         _loc2_.hideWalls = this.var_586.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_885,_loc2_.tags);
         this.addTag(this.var_886,_loc2_.tags);
         this.clearErrors();
         this.var_1101 = _loc2_.roomId;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_175,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_67,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
