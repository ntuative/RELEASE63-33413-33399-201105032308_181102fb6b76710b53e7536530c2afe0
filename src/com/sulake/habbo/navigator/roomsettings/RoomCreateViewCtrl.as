package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1305:TextFieldManager;
      
      private var var_45:Array;
      
      private var var_1304:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_687 = new Timer(100);
         this.var_687.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_46,540,"t"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_46,512,"w"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_46,396,"x"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_46,440,"y"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_46,456,"z"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_46,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_687)
         {
            this.var_687.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_687.reset();
            this.var_687 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1304.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2056 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2056 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_1305 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_194.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1305.goBackToInitialState();
         this.var_1305.input.textBackgroundColor = 4294967295;
         this.var_1304 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_67,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1305.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1305.getText();
         var _loc3_:String = "model_" + this.var_1304.name;
