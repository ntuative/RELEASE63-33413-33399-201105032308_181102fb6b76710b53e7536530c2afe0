package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1722:IButtonWindow;
      ...
      private var var_2286:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1722 = IButtonWindow(this.find("bg_tab"));
         this.var_1721 = IButtonWindow(this.find("top_tab"));
         this.var_1723 = IButtonWindow(this.find("obj_tab"));
         this.var_2287 = IWindowContainer(this.find("tile_grid"));
         this.var_2286 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1722,this.onBgTabButton);
         Util.setProcDirectly(this.var_1721,this.onTopTabButton);
         Util.setProcDirectly(this.var_1723,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_67.mode = ThumbnailEditorModel.const_40;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1722,this.var_67.mode != ThumbnailEditorModel.const_40);
         this.setEnabled(this.var_1721,this.var_67.mode != ThumbnailEditorModel.const_61);
         this.setEnabled(this.var_1723,this.var_67.mode != ThumbnailEditorModel.const_36);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2286;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_67.mode == ThumbnailEditorModel.const_40);
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_67,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_643,HabboWindowStyle.const_44,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_321,HabboWindowStyle.const_44,HabboWindowParam.const_63,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
