package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_588:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_588[this.var_1078] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
      ...
      {
         var _loc1_:IFrameWindow = this._navigator.getXmlWindow(this.var_1078,2) as IFrameWindow;
