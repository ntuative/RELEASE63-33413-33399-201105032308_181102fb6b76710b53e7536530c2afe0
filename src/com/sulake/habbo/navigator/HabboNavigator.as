package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_444:RoomInfoViewCtrl;
      
      private var var_1242:RoomCreateViewCtrl;
      ...
      private var var_2730:RoomThumbnailRenderer;
      
      private var var_884:GuestRoomPasswordInput;
      
      private var var_311:GuestRoomDoorbell;
      
      private var var_1243:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_444 = new RoomInfoViewCtrl(this);
         this.var_1242 = new RoomCreateViewCtrl(this);
         this.var_2730 = new RoomThumbnailRenderer(this);
         this.var_884 = new GuestRoomPasswordInput(this);
         this.var_311 = new GuestRoomDoorbell(this);
         this.var_452 = new Tabs(this);
         this.var_1243 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_321,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_444.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_37)
         {
            ...
            {
               this.var_444.handleToolbarEvent(param1);
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_316.startSearch(Tabs.const_276,Tabs.const_407,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_316.startSearch(Tabs.const_333,Tabs.const_281);
         this.var_452.getTab(Tabs.const_333).tabPageDecorator.tabSelected();
      }
