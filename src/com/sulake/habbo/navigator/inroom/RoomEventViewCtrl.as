package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_2280.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_728.setText(param1.eventDescription);
         this.var_885.setText(this.getTagFromEvent(param1,1));
         this.var_886.setText(this.getTagFromEvent(param1,2));
         this.var_1386.visible = false;
         this.var_1388.visible = true;
         this.var_1387.visible = true;
         this.var_1712.visible = false;
         this.var_1713.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_909.visible = true;
         this.var_1714.visible = false;
         ...
         this.var_1712.visible = true;
         this.var_1713.visible = false;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.addTag(_loc6_,this.var_886.getText());
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1714 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2280 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1712 = ITextWindow(this.find("create_caption"));
            this.var_1713 = ITextWindow(this.find("edit_caption"));
            this.var_1386 = IButtonWindow(this.find("create_button"));
            this.var_1388 = IButtonWindow(this.find("edit_button"));
            this.var_2279 = IButtonWindow(this.find("cancel_button"));
            this.var_1387 = IButtonWindow(this.find("end_button"));
            this.var_909 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1386,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1388,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1387,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2279,this.onCancelButtonClick);
            ...
            this.var_885 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_886 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
