package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1419:String = "pixelbalance";
      
      private static const const_1421:String = "badges";
      
      private static const const_1423:String = "selectbadge";
      
      private static const const_1418:String = "inventory";
      
      private static const const_1417:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1422:String = "friendlist";
      
      private static const const_1420:String = "pet_inventory";
      
      private static const const_1424:String = "go_to_room";
      ...
      private var var_980:ClubGiftNotification;
      
      private var var_982:ClubEndingNotification;
      
      private var var_981:ClubPromoNotification;
      
      private var var_1487:Dictionary;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         this.var_1218.push(_loc8_);
         return this.var_1218.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1218.splice(0,1);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_791.events.addEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_70)
         {
            ...
            this.var_372 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_979["styles"],this.var_979["view"],this.var_791);
            ...
            this._communication.addHabboConnectionMessageEvent(new RespectNotificationMessageEvent(this.method_5));
            ...
            this.var_367.events.addEventListener(BadgeImageReadyEvent.const_139,this.onBadgeImage);
            this.var_791.events.addEventListener(HabboToolbarEvent.const_534,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1487[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_367);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1487[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1487[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function method_5(param1:IMessageEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         ...
         if(this.var_367.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1175,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1175,null);
            }
         }
      }
      ...
      {
         this.addItem(param1,NotificationType.const_698,null);
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_536.createAvatarImage(param2,AvatarScaleType.const_56);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_367.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_64)
               {
                  _loc7_ = this.var_367.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_367.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1167)
         {
            return;
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_982 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_981 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_372.isSpaceAvailable() && this.var_1218.length > 0)
         {
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1272,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1272,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_536.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_56);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2589)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_698,null);
            this.var_2589 = true;
      ...
      {
         if(param2.type == WindowEvent.const_173 || param2.type == WindowEvent.const_606)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_980 && this.var_980.visible)
         {
            return;
         }
         this.var_980 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_698,_loc6_);
      }
   }
}
