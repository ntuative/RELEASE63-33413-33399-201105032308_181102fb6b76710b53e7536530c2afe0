package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1890:String = "badge_bg_001_png";
      
      private const const_2170:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2752 = this.var_58.getBadgeName(this.var_317);
         this.var_2747 = this.var_58.getBadgeDesc(this.var_317);
         this.var_2749 = this.var_58.getAchievementNameForFacebook(this.var_317,this.var_367.userName,this.var_367.realName,this.var_1525);
         this.var_2748 = this.var_58.getAchievementDescForFacebook(this.var_317,this.var_367.userName,this.var_367.realName,this.var_1525);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2750 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_58.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1802.toString());
         this.var_58.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1526.toString());
         this.var_58.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1526.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1973;
         var _loc17_:String = this.var_1973 == 0 ? "pixels" : "activitypoints";
         this.var_58.registerParameter(_loc16_,_loc17_,"" + this.var_2735);
         _loc15_.caption = this.var_58.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1890);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2170) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_58.registerParameter(param1,"badge_name",this.var_2752);
         this.var_58.registerParameter(param1,"badge_desc",this.var_2747);
         this.var_58.registerParameter(param1,"badge_name_fb",this.var_2749);
         this.var_58.registerParameter(param1,"badge_desc_fb",this.var_2748);
         this.var_58.registerParameter(param1,"level",this.var_1525.toString());
         this.var_58.registerParameter(param1,"name",this.var_367.userName);
         return this.var_58.registerParameter(param1,"realname",this.var_367.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_367.events.removeEventListener(BadgeImageReadyEvent.const_139,this.onBadgeImageReady);
            this.var_367 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1890);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_317,this._feedTitleFb,this.var_2750,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2751));
