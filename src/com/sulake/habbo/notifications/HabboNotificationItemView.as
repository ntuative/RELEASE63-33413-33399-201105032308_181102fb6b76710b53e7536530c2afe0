package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_553:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_564:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_2015 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_2015 = 15;
         }
         this.var_2016 = this._window.height;
         this.var_834 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_564:
               ...
               _loc2_ = Number(this.var_1284) / Number(this.var_459["time_fade_in"]);
               if(this.var_1284 > int(this.var_459["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1062:
               ...
               if(this.var_1567 > int(this.var_459["time_display"]) && !this.var_2014)
               {
                  this.startFadeOut();
               }
               break;
            case const_1063:
               ...
               _loc3_ = 1 - Number(this.var_1283) / Number(this.var_459["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1283 > int(this.var_459["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2015;
         if(this._window.height < this.var_2016)
         {
            this._window.height = this.var_2016;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         if(this.var_459["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_553;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_553;
            }
         }
         ...
         if(this.var_459["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_834;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_834;
            }
         }
