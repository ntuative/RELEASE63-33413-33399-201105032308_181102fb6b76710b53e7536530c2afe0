package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2299:PseudoRandom;
      ...
      private const const_1846:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_609 = param1;
            this.var_55.initConnection(HabboConnectionType.const_263);
         }
      }
      ...
      {
         if(this.var_55 && this.var_132 && this.var_16 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_609 = this.var_132.getKey("sso.ticket",null);
         this.var_1732 = this.var_132.getKey("flash.client.url","");
         this.var_2297 = this.var_132.getKey("external.variables.txt","");
         if(this.var_220 == null)
         {
            this.var_220 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_55.mode = HabboConnectionType.const_100;
            if(this.var_609)
            {
               this.var_55.initConnection(HabboConnectionType.const_263);
            }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_55.mode = HabboConnectionType.const_1215;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_263);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_772);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2299 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_100:
               ...
               this.var_1393 = _loc4_;
               this.var_220.loadBannerImage(_loc7_ + "?token=" + this.var_1393,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1215:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1687:
               this.var_918 = this.generateRandomHexString(30);
               this.var_494 = new DiffieHellman(new BigInteger(this.var_132.getKey("connection.development.prime"),16),new BigInteger(this.var_132.getKey("connection.development.generator"),16));
               this.var_494.init(this.var_918);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2299);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1732,this.var_2297));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1846,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2298)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1393);
