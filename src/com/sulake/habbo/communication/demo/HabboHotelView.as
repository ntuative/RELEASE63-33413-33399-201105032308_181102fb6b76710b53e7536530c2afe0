package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_766:IDesktopWindow;
      ...
      private var var_841:IAssetLibrary;
      
      private var var_1290:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_841 = param2;
         this._events = param3;
         this.var_766 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_841.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_841.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_29)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_487));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_841.loadAssetFromFile("hotel_view_banner_" + this.var_1290,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_766.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_766.removeChild(this._window);
         }
      }
   }
}
