package com.sulake.habbo.communication.messages.parser.friendlist
{
   ...
   public class FriendListUpdateMessageParser implements IMessageParser
   {
      ...
      {
         this.var_2092 = new Array();
         this._removedFriendIds = new Array();
         this.var_2093 = new Array();
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            this.var_2092.push(new FriendCategoryData(param1));
            _loc3_++;
         }
         ...
         while(_loc3_ < _loc4_)
         {
            ...
            {
               this.var_2094.push(new FriendData(param1));
            }
            else if(_loc5_ == 1)
            {
               this.var_2093.push(new FriendData(param1));
            }
            _loc3_++;
         }
         return true;
