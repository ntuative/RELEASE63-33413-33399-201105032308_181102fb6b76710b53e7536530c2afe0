package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1066:String = "FlashExternalInterface.authenticateFacebook";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ...
            ExternalInterface.call(const_1066);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1066);
         }
      }
