package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      {
         if(this._initialized && this.var_2486)
         {
            return true;
         }
         return false;
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1835)
         {
            this.gotoRoom(this.var_2488,this.var_2487,this.var_1834);
            this.var_1835 = false;
            this.var_1834 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_242,_loc7_));
         return true;
      }
