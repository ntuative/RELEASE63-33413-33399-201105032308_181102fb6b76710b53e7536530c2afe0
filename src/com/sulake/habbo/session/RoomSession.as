package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2121:int = 2500;
      ...
      {
         if(this._state == RoomSessionEvent.const_242 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1401));
         this.var_1402.add(this.var_1401,getTimer());
         ++this.var_1401;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1402.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2121)
            {
