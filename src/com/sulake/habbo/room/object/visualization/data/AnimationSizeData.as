   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_312.add(_loc6_,_loc8_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         var _loc3_:AnimationData = this.var_312.getValue(param1) as AnimationData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:AnimationData = this.var_312.getValue(param1) as AnimationData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc8_:* = null;
         var _loc7_:AnimationData = this.var_312.getValue(param1) as AnimationData;
         if(_loc7_ != null)
         {
