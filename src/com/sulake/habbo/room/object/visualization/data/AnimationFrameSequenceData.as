package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationFrameSequenceData
   {
      ...
      {
         return this.var_428.length * this._loopCount;
      }
      ...
      public function initialize() : void
      {
         var _loc1_:int = 1;
         var _loc2_:int = -1;
         var _loc3_:int = this.var_428.length - 1;
         while(_loc3_ >= 0)
         {
            if(this.var_428[_loc3_] == _loc2_)
            {
               _loc1_++;
            }
            else
            {
               _loc2_ = this.var_428[_loc3_];
               _loc1_ = 1;
            }
            this.var_1054[_loc3_] = _loc1_;
            _loc3_--;
         }
      }
      ...
      public function addFrame(param1:int, param2:int, param3:int, param4:int, param5:int, param6:DirectionalOffsetData) : void
      {
         ...
         this.var_428.push(this._frames.length - 1);
      ...
      public function getFrame(param1:int) : AnimationFrameData
      {
         ...
         param1 = this.var_428[param1 % this.var_428.length];
      ...
      public function getFrameIndex(param1:int) : int
      {
         ...
         if(this.var_1762)
         {
            param1 = Math.random() * this.var_428.length;
            if(param1 == this.var_428.length)
            {
               param1--;
            }
         }
      ...
      public function getRepeats(param1:int) : int
      {
         ...
         return this.var_1054[param1 % this.var_1054.length];
      }
   }
}
