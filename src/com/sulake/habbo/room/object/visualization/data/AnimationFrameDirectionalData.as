package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationFrameDirectionalData extends AnimationFrameData
   {
      ...
      private var var_943:DirectionalOffsetData;
      ...
      override public function getX(param1:int) : int
      {
         ...
         {
            return this.var_943.getOffsetX(param1,super.getX(param1));
         }
      ...
      override public function getY(param1:int) : int
      {
         if(this.var_943 != null)
         {
            return this.var_943.getOffsetY(param1,super.getY(param1));
         }
