package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1339:String = "shore";
      ...
      {
         if(this.var_2225 == param1 && this.var_2224 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1339)
            {
               this.var_1676 = _loc2_;
               this.var_2225 = param1;
               this.var_2224 = direction;
               return this.var_1676;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1675 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_413.length)
         {
            if(this.var_413[_loc5_] == true)
            {
               this.var_1675 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_484 == 0 || this.var_591 == 0)
         {
            ...
            this.var_484 = _loc2_.getNumber(RoomObjectVariableEnum.const_305);
            this.var_591 = _loc2_.getNumber(RoomObjectVariableEnum.const_395);
         }
         this.var_413 = [];
         this.var_590 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_484 * 2 + this.var_591 * 2)
         {
            this.var_413.push(false);
            this.var_590.push(ShoreMaskCreatorUtility.const_83);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_413,this.var_590,assetCollection);
      }
