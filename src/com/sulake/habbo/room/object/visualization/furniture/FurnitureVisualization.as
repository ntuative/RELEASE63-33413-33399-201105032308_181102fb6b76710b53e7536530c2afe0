package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1834:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2231:Number = NaN;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1375 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1375;
            this.var_1375 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2232;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_475 != _loc3_.getUpdateID() || param1 != var_87 || param2 != this.var_2231)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2230 = _loc3_.getNumber(RoomObjectVariableEnum.const_271);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_304));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1113 = this.getAdClickUrl(_loc3_);
            if(this.var_1113 == null || this.var_1113.indexOf("http") != 0)
            {
               this.var_1113 = null;
            }
            this.var_2232 = this.var_1113 != null;
            this.var_2234 = _loc3_.getNumber(RoomObjectVariableEnum.const_830);
      ...
      {
         if(this.var_2228 != param2 || this.var_2233 != param1)
         {
            this.var_892 = [];
            this.var_891 = [];
            this.var_719 = [];
            ...
            this.var_2229 = this.getSize(param1);
      ...
      {
         this.var_675 = param1;
         this.var_1374 = this.var_675 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_612.length)
         {
            return "";
         }
         var _loc3_:String = this.var_892[param2];
         var _loc4_:Boolean = this.var_891[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2229;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1374)
            {
               _loc6_ = FurnitureVisualizationData.const_612[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_892[param2] = _loc3_;
            this.var_891[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_722[param3] != null && !this.var_1678)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2234 * (param1 / 2));
      }
