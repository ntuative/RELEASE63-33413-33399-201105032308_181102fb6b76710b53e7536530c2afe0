package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_682)
         {
            for each(_loc1_ in this.var_682)
            {
               _loc1_.dispose();
            }
            this.var_682 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_236 = this.var_682[param1];
               _loc3_ = true;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1105);
         if(_loc3_.length == 0)
         {
