package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1567:String = "plane";
      ...
      private var var_1062:Number = 0.1;
      
      private var var_2088:Number;
      
      private var var_282:Number;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_2896 = param9;
         this._energy = param8;
         this.var_2899 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_1063 = 0;
         this.var_975 = false;
         this.init(0,0,0,this._direction,this.var_2897,this.var_1062,this.var_2896,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1321.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_975 = true;
         if(this.var_1063 < this.var_1602)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2900)
         {
            switch(this.var_2895)
            {
               case const_1714:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1062,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_396.push(_loc4_);
            ++this.var_1063;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1321.length);
         return this.var_1321[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1063 < this.var_1602)
         {
            if(this.age % this.var_2899 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1063 < this.var_1602)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_282) * this.x - (1 - this.var_282) * this.lastX;
            this.y = (2 - this.var_282) * this.y - (1 - this.var_282) * this.lastY + this.var_2088 * this.var_1062 * this.var_1062;
            this.z = (2 - this.var_282) * this.z - (1 - this.var_282) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_396)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_282) * _loc2_.x - (1 - this.var_282) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_282) * _loc2_.y - (1 - this.var_282) * _loc2_.lastY + this.var_2088 * this.var_1062 * this.var_1062;
            _loc2_.z = (2 - this.var_282) * _loc2_.z - (1 - this.var_282) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_396.splice(this.var_396.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
