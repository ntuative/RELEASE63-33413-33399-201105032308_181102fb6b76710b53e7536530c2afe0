package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_829 = param1.@defaultPosture;
         }
         else
         {
            this.var_829 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_680.add(_loc6_,_loc7_);
         ...
         if(this.var_680.getValue(this.var_829) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_830.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_830.getValue(param1) == null)
         {
            return const_826;
         }
         return int(this.var_830.getValue(param1));
      }
      
      public function getPostureForAnimation(param1:int) : String
      {
         if(param1 >= 0 && param1 < this.var_680.length)
         {
            return this.var_680.getKey(param1);
         }
         return this.var_829;
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_830.length)
         {
            return this.var_830.getKey(param1);
         }
         return null;
      }
