package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1514:String = "head";
      
      private static const const_681:int = 1;
      
      private static const const_1070:int = 1000;
      
      private static const const_1515:String = "pet_experience_bubble_png";
      
      private static const const_1516:int = 0;
      
      private static const const_1517:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1515) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_393 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2860)
            {
               this.var_2860 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_264);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_157);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_264);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1766 = _loc3_.getNumber(RoomObjectVariableEnum.const_376) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_196);
            if(!isNaN(_loc8_))
            {
               this.var_2053 = _loc8_;
            }
            else
            {
               this.var_2053 = direction;
            }
            this.var_1588 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2580 = _loc3_.getNumber(RoomObjectVariableEnum.const_910);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_935);
            if(_loc9_ != this.var_2052)
            {
               this.var_2052 = _loc9_;
               this.var_2861 = this.var_2052.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_393 != null)
         {
            ...
            if(this.var_1588 > 0)
            {
               ...
               if(_loc2_ < const_1070)
               {
                  this.var_393.alpha = int(Math.sin(_loc2_ / const_1070 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_393.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_393.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         if(param1 != this.var_252)
         {
            ...
            this.setAnimationForIndex(const_1516,_loc3_);
         }
         if(param2 != this.var_1411)
         {
            this.var_1411 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_87,param2);
            this.setAnimationForIndex(const_1517,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_681;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2861);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_681)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_681))
            {
               if(param2 >= FurnitureVisualizationData.const_612.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_612[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2053);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_87,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1514)
            {
               this.var_1050[param1] = true;
            }
            else
            {
               this.var_1050[param1] = false;
            }
         }
