package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_648:String = "com.sulake.habbo.roomevents.userdefinedroomevents.common";
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc3_ = this.var_347.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
      ...
      private function resetMaterials() : void
      {
         ...
         while(_loc1_ < this.var_347.length)
         {
            _loc2_ = this.var_347.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_347.getValue(param1) as PlaneMaterial;
      }
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               while(_loc8_ < _loc7_.length())
               {
                  ...
                  this.var_347.add(_loc5_,_loc6_);
                  _loc8_++;
               }
            }
            _loc3_++;
