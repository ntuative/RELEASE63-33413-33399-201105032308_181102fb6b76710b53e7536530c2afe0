package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1683:int = 0;
      ...
      private var var_1039:IPlaneRasterizer = null;
      
      private var var_846:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_2836:Number = 0;
      
      private var var_2832:Number = 0;
      ...
      {
         return this._isVisible && this.var_838;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1039.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_838 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_390))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_319.length * param1.scale;
            ...
            if(this.var_1039 != null)
            {
               _loc3_ = this.var_1039.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2033,this.var_2836,this.var_2832,this.var_2833,this.var_2835,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1806 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_838)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1379.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1379[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_168.z - originZ,this.var_122.z - originZ,this.var_85.z - originZ,this.var_121.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2774 = relativeDepth;
            this._isVisible = true;
            this.var_1806 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2834);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_135 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_135 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_1041)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_391.length)
            {
               _loc5_ = this.var_391[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_279.length == this.var_1040.length)
         {
            while(_loc1_ < this.var_279.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_1040[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_391.length > this.var_1578.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1041 || this.var_279.length == 0 && this.var_391.length == 0 && !this.var_390 || this.var_846 == null)
         {
            return;
         }
         ...
         if(this.var_390)
         {
            ...
            while(_loc5_ < this.var_279.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc3_.leftSideLoc / this.var_319.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc3_.rightSideLoc / this.var_320.length;
                  _loc12_ = _loc3_.type;
                  this.var_846.updateMask(this.var_70,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1040.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_391.length)
            {
               _loc4_ = this.var_391[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc4_.leftSideLoc / this.var_319.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc4_.rightSideLoc / this.var_320.length;
                  _loc13_ = this.var_70.width * _loc4_.leftSideLength / this.var_319.length;
                  _loc14_ = this.var_70.height * _loc4_.rightSideLength / this.var_320.length;
                  this.var_70.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1578.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_390 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_235.copyChannel(param1,param1.rect,const_678,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_235.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_235,this.var_235.rect,const_678,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
