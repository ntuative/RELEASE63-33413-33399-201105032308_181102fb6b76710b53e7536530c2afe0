package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2005:int = 16777216;
      ...
      private var var_1990:int = 16777216;
      
      private var var_2973:int = 69069;
      
      private var var_2974:int = 5;
      ...
      {
         var _loc1_:int = this.var_2973 * this.var_1989 + this.var_2974;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1990;
         this.var_1989 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1990 * param2);
      }
   }
}
