package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1261:Point = null;
      
      private var var_1539:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_1017)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1539 = this.var_45.getValue(this.var_1017);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2772 = new Vector3d(-0.5,0.5,0);
         this.var_1016 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2772);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1261.x = _loc3_.x;
         this.var_1261.y = _loc3_.y;
      }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1991 = RoomObjectVariableEnum.const_1203;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1991 = RoomObjectVariableEnum.const_1125;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1260 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1260 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         if(param2 == this.var_2770 && param3 == this.var_2771)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1260 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1260 + this._adImgIndex);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1539.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1261.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1261.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_451.indexOf(_loc10_) >= 0 && this.var_1016)
            {
               ...
               {
                  _loc9_ = this.var_792.getAsset(this.var_672[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_673[param1] != -1)
               {
                  param2.alpha = this.var_673[param1];
               }
               this.var_451.splice(param1,1);
               this.var_672.splice(param1,1);
               this.var_673.splice(param1,1);
      ...
      public function changeElementAlpha(param1:String, param2:Number) : void
      {
         ...
         if(_loc3_ < 0)
         {
            this.var_451.push(param1);
            this.var_672.push("");
            this.var_673.push(param2);
         }
         else
         {
            this.var_673[_loc3_] = param2;
         }
      }
   }
}
