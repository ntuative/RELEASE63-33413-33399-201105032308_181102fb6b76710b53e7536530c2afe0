package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1707:int = 16777215;
      
      public static const const_1734:int = 13421772;
      
      private static const const_1048:int = 16777215;
      
      private static const const_1046:int = 13421772;
      
      private static const const_1049:int = 10066329;
      
      private static const const_1047:int = 10066329;
      
      public static const const_1562:int = 16777215;
      
      public static const const_1832:int = 13421772;
      
      public static const const_1733:int = 10066329;
      ...
      private var var_805:Rectangle = null;
      ...
      private var var_1609:String = null;
      
      private var var_2709:String = null;
      
      private var var_1237:uint = 16777215;
      
      private var var_2712:int = 255;
      
      private var var_2708:int = 255;
      ...
      private const const_2161:int = 250;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_805 = super.boundingRectangle;
         }
         return new Rectangle(this.var_805.x,this.var_805.y,this.var_805.width,this.var_805.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_135 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1128);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_180)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_135,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_358)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1793)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_135,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_358)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1753 + this.const_2161 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_376.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1951)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2707 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2708 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1806)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1540 || _loc3_.y != this.var_2710 || _loc3_.z != this.var_2713 || param1.scale != this.var_2711))
            {
               this.var_1540 = _loc3_.x;
               this.var_2710 = _loc3_.y;
               this.var_2713 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1236);
            if(_loc3_ != this.var_2709)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2709 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_850));
            if(_loc4_ != this.var_1237)
            {
               this.var_1237 = _loc4_;
               this.var_2707 = this.var_1237 & 255;
               this.var_2708 = this.var_1237 >> 8 & 255;
               this.var_2712 = this.var_1237 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1191));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_174 != param1.getUpdateID())
         {
            ...
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_939));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_921));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_776));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_140.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_236 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_135 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_236)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1878;
      }
         ...
         while(_loc8_ < this.var_525.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_140.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_135 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_135 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_284)
                              {
