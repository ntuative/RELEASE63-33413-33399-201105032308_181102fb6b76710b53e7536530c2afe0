package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1875:Number = 0.0;
      
      private var var_1216:Number = 0.0;
      
      private var var_139:Number = 0.0;
      
      private var var_964:Number = 0.0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_277 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_518 || param1 == this.var_515)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_516;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_964 = getFloorHeight(this.var_162);
         if(!param1)
         {
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_180,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_358,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1216);
         this.addPlane(RoomPlaneData.const_180,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_180,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_139) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_180,Vector3d.sum(param1,Vector3d.product(param3,-this.var_139 / param3.length)),Vector3d.product(param3,(param3.length + this.var_139) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1216 / param2.length);
               this.addPlane(RoomPlaneData.const_180,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_199,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_199,_loc13_,new Vector3d(0,0,-this.var_139),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_199,_loc13_,new Vector3d(0,0,-this.var_139),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_199,_loc13_,new Vector3d(0,0,-this.var_139),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_199,_loc13_,new Vector3d(0,0,-this.var_139),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1145;
         }
         var _loc2_:RoomPlaneData = this.var_140[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
