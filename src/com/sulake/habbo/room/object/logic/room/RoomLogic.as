package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1577:uint = 16777215;
      
      private var var_2030:int = 255;
      
      private var var_1288:uint = 16777215;
      
      private var var_2031:int = 255;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_471,RoomObjectMouseEvent.const_158];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_850,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_939,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_921,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_776,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1287)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1633;
            if(_loc2_ - this.var_1287 >= this.var_2032)
            {
               _loc3_ = this.var_1288;
               _loc4_ = this.var_2031;
               this.var_1287 = 0;
            }
            else
            {
               _loc7_ = this.var_1577 >> 16 & 255;
               _loc8_ = this.var_1577 >> 8 & 255;
               _loc9_ = this.var_1577 & 255;
               _loc10_ = this.var_1288 >> 16 & 255;
               _loc11_ = this.var_1288 >> 8 & 255;
               _loc12_ = this.var_1288 & 255;
               _loc13_ = (_loc2_ - this.var_1287) / this.var_2032;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2030 + (this.var_2031 - this.var_2030) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_850,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_893:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_584:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_284)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_716:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1236,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1280:
               param2.setNumber(RoomObjectVariableEnum.const_939,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1159:
               param2.setNumber(RoomObjectVariableEnum.const_921,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_776,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1191,int(param1.bgOnly));
         this.var_1577 = this._color;
         this.var_2030 = this.var_1633;
         this.var_1288 = _loc3_;
         this.var_2031 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1737,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1588,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1826,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_180 || _loc12_ == RoomPlaneData.const_358)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
