package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_1006:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_744 != _loc2_)
         {
            ...
            if(_loc3_ * const_454 > const_1006)
            {
               this.var_1147 = const_1006 / _loc3_;
            }
            else
            {
               this.var_1147 = const_454;
            }
            this.var_1403 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_744 && param1 >= this.var_1403 + this.var_1147)
            {
               _loc3_ = param1 - this.var_1403;
               _loc4_ = _loc3_ / this.var_1147;
               _loc5_ = 1;
               if(this.var_744 < _loc2_)
               {
                  _loc5_ = -1;
               ...
               this.var_1403 = param1 - (_loc3_ - _loc4_ * this.var_1147);
            }
         }
      }
   }
