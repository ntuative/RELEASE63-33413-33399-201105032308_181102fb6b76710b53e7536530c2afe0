package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSongDiskLogic extends FurnitureLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object.getModelController().getNumber(RoomObjectVariableEnum.const_825) == 1)
         {
            _loc2_ = object.getModelController().getString(RoomObjectVariableEnum.const_336);
            _loc3_ = int(_loc2_);
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_437,RoomWidgetInfostandExtraParamEnum.const_383 + _loc3_);
         }
      }
   }
}
