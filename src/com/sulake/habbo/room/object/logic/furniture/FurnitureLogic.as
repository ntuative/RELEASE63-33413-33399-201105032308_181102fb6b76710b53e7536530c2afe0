package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private static const const_453:int = 8;
      
      private static const const_994:Number = 0.0625;
      ...
      private var var_1384:Number = 0.0;
      ...
      private var var_1127:RoomObjectUpdateMessage;
      
      private var var_901:Vector3d;
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_316,RoomObjectRoomAdEvent.const_346,RoomObjectRoomAdEvent.const_636,RoomObjectStateChangeEvent.const_86,RoomObjectMouseEvent.const_158,RoomObjectRoomAdEvent.const_215,RoomObjectMouseEvent.const_498];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc3_.length() == 1)
         {
            this.var_1384 = Number(_loc3_);
         }
         this.var_2268 = this.var_484 / 2;
         this.var_2267 = this.var_591 / 2;
         _loc3_ = _loc2_.@centerZ;
         if(_loc3_.length() == 1)
         {
            this.var_1704 = Number(_loc3_);
         }
         else
         {
            this.var_1704 = this.var_1384 / 2;
         }
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_305,this.var_484,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_395,this.var_591,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_821,this.var_1384,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1680,this.var_2268,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1543,this.var_2267,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1121,this.var_1704,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_691,this.var_253,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_304,1);
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.DOUBLE_CLICK:
               ...
               if(eventDispatcher != null && _loc7_ != null && _loc7_.indexOf("http") == 0)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_636,_loc4_,_loc5_));
               }
               if(eventDispatcher != null)
               {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc2_.setString(RoomObjectVariableEnum.const_336,String(param1.extra));
            }
            _loc2_.setNumber(RoomObjectVariableEnum.const_880,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1155,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_1705 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_346 = 1;
                  this.var_1127 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_1705 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_346 > 0)
         {
            this.var_901.x = 0;
            this.var_901.y = 0;
            if(this.var_346 <= const_453 / 2)
            {
               this.var_901.z = const_994 * this.var_346;
            }
            else if(this.var_346 <= const_453)
            {
               if(this.var_1127)
               {
                  super.processUpdateMessage(this.var_1127);
                  this.var_1127 = null;
               }
               this.var_901.z = const_994 * (const_453 - this.var_346);
            }
            return this.var_901;
         }
         return null;
