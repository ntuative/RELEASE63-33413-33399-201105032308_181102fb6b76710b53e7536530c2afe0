package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_158,RoomObjectMoveEvent.const_396];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2845)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1579 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_910,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1547,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_935,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_196,_loc3_ + this.var_1044);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2037;
            _loc2_.setNumber(RoomObjectVariableEnum.const_264,this.var_2037);
            _loc2_.setNumber(RoomObjectVariableEnum.const_157,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2036;
            _loc2_.setNumber(RoomObjectVariableEnum.const_157,this.var_2036);
         }
         else
         {
            this.var_1044 += 45;
