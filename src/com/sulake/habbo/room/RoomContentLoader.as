package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_870:String = "RCL_LOADER_READY";
      
      private static const const_372:String = "RCL_PUBLICROOM_";
      
      private static const const_1898:int = 0;
      ...
      private static const const_686:String = "wall_place_holder";
      
      private static const const_685:String = "pet_place_holder";
      ...
      private static const const_1082:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2912 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_1083)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2909 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2911 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2913 = param2.getKey("public.room.dynamic.download.url","");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_567.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_567.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_861.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_698.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_697.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_697.remove(_loc7_);
               this.var_697.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2910)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_870));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_566 != null)
         {
            this.var_566.remove(param1);
            this.var_566.add(param1,param2);
         }
         if(this.var_568 != null)
         {
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_566 != null)
         {
            _loc2_ = this.var_566.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_306;
         }
         return RoomObjectCategoryEnum.const_186;
      }
      ...
      {
         return [const_468,const_686,const_685,const_684,TILE_CURSOR,const_1082];
      }
      ...
      {
         var _loc3_:String = this.var_698.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_698.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_861.getValue(param1) != null)
         {
            return this.var_861.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_216 != null && this.var_216.hasWorldType(const_372 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_293 || param1 == RoomObjectVisualizationEnum.const_72 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_697.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2913 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1611.getValue(param1) != null)
         {
            this.var_216 = this.var_1611.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_782,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2912.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1772);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_641,_loc5_);
         }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1611.add(param1,_loc4_);
         this.var_216 = _loc4_;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_567.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_567.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_567.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_485.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_216.getWorldHeightScale(const_372 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_216 != null)
         {
            return this.var_216.getWorldScale(const_372 + param1);
         }
         return 32;
      }
