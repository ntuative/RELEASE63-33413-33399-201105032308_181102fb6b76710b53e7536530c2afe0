package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2664:IContainerButtonWindow;
      
      private var var_2663:IContainerButtonWindow;
      
      private var var_2471:IContainerButtonWindow;
      ...
      {
         this.var_2662 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2664 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2663 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2471 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2662,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2664,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2663,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2471,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_147)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_147 && _loc4_.online)
            {
