package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2574:FriendListLookAndFeel;
      
      private var var_452:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1880:OpenedToWebPopup;
      ...
      {
         this.var_2574 = new FriendListLookAndFeel();
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_634.stop();
            this.var_634.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_634 = null;
         }
         ...
         if(this.var_1176)
         {
            this.var_1176.release(new IIDAvatarRenderManager());
            this.var_1176 = null;
         }
         if(this.var_1026)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1880 = new OpenedToWebPopup(this);
         }
         this.var_1880.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_347);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_321,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1176.createAvatarImage(param1,AvatarScaleType.const_99,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_1026 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this._view = new FriendListView(this,this.var_176);
         ...
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1186,this.getText("friendlist.friends")));
         ...
         this.var_452 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_634)
         {
            this.var_634 = new Timer(120000);
            this.var_634.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_634.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.FRIENDLIST));
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_452.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_424));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_452.findTab(FriendListTab.const_95).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_452.findTab(FriendListTab.const_95);
      ...
      {
         var _loc2_:FriendListTab = this.var_452.findTab(FriendListTab.const_95);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_788 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_788.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_788.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_179) as IBitmapWrapperWindow;
