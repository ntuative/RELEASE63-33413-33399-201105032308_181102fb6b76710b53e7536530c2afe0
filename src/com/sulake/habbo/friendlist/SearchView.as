package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_787.addEventListener(WindowKeyboardEvent.const_187,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this._list.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_347,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc4_ = 25;
            _loc5_ = this.var_787.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_787.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
