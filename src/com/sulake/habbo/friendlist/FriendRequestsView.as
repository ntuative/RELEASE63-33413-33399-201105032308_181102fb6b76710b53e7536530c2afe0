package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1852:String = "no_reqs_info";
      ...
      {
         this.var_1760 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1761 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1761.procedure = this.onDismissAllButtonClick;
         this.var_1760.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_391 && _loc4_.state != FriendRequest.const_378)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1760,_loc1_);
