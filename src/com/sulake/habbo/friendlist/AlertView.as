package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_588[this.var_1078]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var_588[this.var_1078] = this._alert;
      }
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(this._friendList.getXmlWindow(this.var_1078));
