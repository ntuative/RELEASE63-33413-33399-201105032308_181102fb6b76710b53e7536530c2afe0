package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_432:int = 100;
      ...
      {
         return Math.ceil(this.var_225.length / const_432);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_955 * const_432;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_955 + 1) * const_432,this.var_225.length);
      }
