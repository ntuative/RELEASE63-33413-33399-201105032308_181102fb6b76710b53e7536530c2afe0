package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_749 = param1.online;
         this.var_1657 = param1.followingAllowed && param1.online;
         this.var_652 = param1.figure;
         this.var_1659 = param1.motto;
         this.var_1658 = param1.lastAccess;
         this.var_1541 = param1.categoryId;
         this.var_1656 = param1.realName;
