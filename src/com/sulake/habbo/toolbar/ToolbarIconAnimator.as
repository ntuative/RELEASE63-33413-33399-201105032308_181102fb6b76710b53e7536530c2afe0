package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_1533 = param1.loop;
         if(param1.background != null)
         {
            this.var_816 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_1011.push(new XML());
               this.var_1010.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_1010[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1533 == true || this.var_1012 == 0)
         {
      ...
      {
         return this.var_1011.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1533 == false && this.var_1012 == 1 && this.var_1715 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_1010.length)
         {
            _loc2_ = this.var_1010[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_816.width),Math.max(param2.height,this.var_816.height),true,0);
            _loc4_ = _loc3_.height - this.var_816.rect.height;
            _loc3_.copyPixels(this.var_816,this.var_816.rect,new Point(0,_loc4_),null,null,true);
