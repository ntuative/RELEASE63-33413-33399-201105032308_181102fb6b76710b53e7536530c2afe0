package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private static const const_1426:uint = 12247545;
      
      private static const const_1427:String = "HELP";
      
      private static const const_1428:String = "ROOMINFO";
      ...
      private const const_476:int = 44;
      ...
      public function LogoutController(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_324 = this._window.findChildByName("roominfo_region");
         ...
         this.hideRoomInfo();
         this.var_1902 = this._config.getKey("roominfo.widget.enabled") == "1";
         if(this.var_1902)
         {
            this._events.addEventListener(HabboToolbarEvent.const_314,this.onRoomView);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_1902)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_314,this.onRoomView);
      ...
      {
         this._list.removeListItem(this.var_324);
      }
      
      private function showRoomInfo() : void
      {
         this._list.addListItemAt(this.var_324,0);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_562;
         _loc3_.y = this.const_476;
         return _loc3_;
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1427);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1428);
               break;
            case "confirm":
               if(false)
               {
