package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView implements IToolbarView
   {
      ...
      private var var_539:String = "LEFT";
      
      private var var_167:Number = 50;
      
      private var var_1250:Boolean = true;
      
      private var var_1249:Number = 1;
      
      private var _toolbarMarginBottom:Number = 0;
      
      private var _toolbarMinGroupMargin:Number = 15;
      
      private var var_1972:Number = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         this.var_167 = this._window.width;
         this.var_234 = param2.createWindow("extrabar_container_window","",HabboWindowType.const_67,HabboWindowStyle.const_1288,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1250 = String(_loc9_.relocate_by_drag.@state) == "true";
         if(this.var_1250)
         {
         ...
         this.var_1249 = _loc9_.toolbar.@margin_top;
         this._toolbarMarginBottom = _loc9_.toolbar.@margin_bottom;
         this._toolbarMinGroupMargin = _loc9_.toolbar.@min_group_margin;
         this.var_1972 = _loc9_.toolbar.@margin_to_extrabar;
         this.var_304 = new ToolbarBarMenuAnimator(param2,this);
         var _loc10_:XMLList = XMLList(_loc9_.toolbar).children();
         var _loc11_:XMLList = XMLList(_loc9_.extras).children();
         this.createGroupsFromXmlList(_loc10_,this.var_268,param2,param3,param4,this._window,this.var_304);
         this.createGroupsFromXmlList(_loc11_,this.var_666,param2,param3,param4,this.var_234,this.var_304);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_167,this._config);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_167,this.var_539,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_539);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_167,this.var_539);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_167,this.var_539);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_869);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_234.x = this.var_167 + this.var_1972;
               this.var_234.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_167;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_167;
               this._window.y = 0;
               this.var_234.x = 0;
               this.var_234.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_167;
               this._window.x = 0;
               this._window.y = 0;
               this.var_234.x = 0;
               this.var_234.y = this.var_167 + this.var_1972;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_167;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_167;
               this.var_234.x = 0;
               this.var_234.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this._toolbarMarginBottom;
         _loc4_ -= this.var_1249;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1249;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_268.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.height - _loc5_ * _loc8_ - this.var_1249 - this._toolbarMarginBottom) / (this.var_268.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.width - _loc5_ * _loc8_ - this.var_1249 - this._toolbarMarginBottom) / (this.var_268.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_268.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_539;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1250 && this.var_1524)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_539)
            {
               this.var_539 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_534);
                  _loc3_.orientation = this.var_539;
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_167)
         {
            return "RIGHT";
         }
         ...
         if(param2 >= _loc3_.height - this.var_167)
         {
            return "BOTTOM";
         }
         return null;
