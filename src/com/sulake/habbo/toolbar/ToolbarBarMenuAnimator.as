package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1373:Number = 25;
      
      private static const const_1371:Number = 90;
      
      private static const const_1021:int = 50;
      ...
      private var var_1430:IToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:IToolbarView)
      {
         ...
         this.var_757 = new Timer(const_1373);
         this.var_757.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_1021 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1021 || param1.desktop.height - param1.y < const_1377;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1430.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1430.getIconLoc(param1.iconId);
      ...
      {
         return this.var_623[this.var_624.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_624[this.var_623.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         this.var_623.push(param1.name);
         this.var_624.push(param2);
         param1.addEventListener(WindowEvent.const_296,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_207,this.windowEventListener);
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_623.length)
         {
            if(this.var_623[_loc2_] == param1.window.name)
            {
