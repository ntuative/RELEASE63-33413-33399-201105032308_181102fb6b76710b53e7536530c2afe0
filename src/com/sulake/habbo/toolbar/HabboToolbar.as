package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1502:LogoutController;
      ...
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_996 = this._config.getKey("client.toolbar.static.enabled","false") == "true";
         this.tryInitialize();
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1502 = new LogoutController(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1114,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_175,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_625,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1147,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1112,this.onHideWindowEvent);
         this._state = true;
