package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1095:IContainerButtonWindow;
      
      private var var_1094:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1636 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1094 = this.var_1636.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1094)
         {
            this.var_1094.procedure = this.onButtonClick;
         }
         this.var_1095 = this.var_1636.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1095)
         {
            this.var_1095.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_247 >= this.var_58.length - 1)
         {
            this.var_1095.disable();
         }
         else
         {
            this.var_1095.enable();
         }
         if(this.var_247 <= 0)
         {
            this.var_1094.disable();
         }
         else
         {
            this.var_1094.enable();
         }
      }
      ...
      {
         ++this.var_247;
         this.var_247 = Math.min(this.var_247,this.var_58.length - 1);
         this.method_2();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_58[this.var_247][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_58[this.var_247][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_58[this.var_247][1]).value;
