package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1477:int = 2;
      ...
      private var var_1871:TriggerConfs;
      
      private var var_1870:ActionTypes;
      
      private var var_1872:ConditionTypes;
      
      private var var_263:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_785:RoomObjectHightLighter;
      
      private var var_112:UserDefinedRoomEventsHelp;
      
      private var var_1213:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1871 = new TriggerConfs();
         this.var_1870 = new ActionTypes();
         this.var_1872 = new ConditionTypes();
         this.var_263 = new Dictionary();
         super();
         this.var_78 = param1;
         this.var_785 = new RoomObjectHightLighter(param1);
         this.var_112 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1213 = new SliderWindowController(this.var_78,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_78.assets,0,20,1);
         this.var_1213.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1213.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_785.hideAll(this.var_263);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_785.showAll(this.var_263);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1213.setValue(_loc6_);
         }
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_78.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_37.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_37 as TriggerDefinition != null)
         {
            this.var_78.send(new UpdateTriggerMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ActionDefinition != null)
         {
            this.var_78.send(new UpdateActionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_37 as ConditionDefinition != null)
         {
            this.var_78.send(new UpdateConditionMessageComposer(this.var_37.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1213.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_112.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1477) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1477 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_78.send(new ApplySnapshotMessageComposer(this.var_37.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1871);
         this.refreshConfigureElement(this.var_1870);
         this.refreshConfigureElement(this.var_1872);
