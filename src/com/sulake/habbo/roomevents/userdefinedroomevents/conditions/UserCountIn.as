package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1107:SliderWindowController;
      
      private var var_1106:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1107.getValue());
         _loc2_.push(this.var_1106.getValue());
         return _loc2_;
      }
      ...
      {
         this.var_78 = param2;
         this.var_1107 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1107.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1107.setValue(1);
         this.var_1106 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1106.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1106.setValue(50);
      }
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1107.setValue(_loc3_);
         this.var_1106.setValue(_loc4_);
      }
