package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1299:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1299,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1047);
         }
      ...
      {
         return int(this.var_1755 * (Number(param1 - this._minValue) / (this.var_1299 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1755 * (this.var_1299 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1048)
         {
            if(param1.type == WindowMouseEvent.const_52 || param1.type == WindowMouseEvent.const_204)
            {
               this.var_1048 = false;
            }
         }
         if(!this.var_1048 || param1.type != WindowEvent.const_296)
         {
            return;
         }
         if(this.var_686 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_686 != 0)
            {
               _loc3_ = this.var_1047 + this.var_686;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_739 != null)
            {
               ...
               this.var_1755 = _loc1_.width - _loc2_.width;
            }
         }
