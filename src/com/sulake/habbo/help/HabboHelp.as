package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_916:IHabboLocalizationManager;
      
      private var var_730:IHabboConfigurationManager;
      
      private var var_367:ISessionDataManager;
      
      private var var_1138:FaqIndex;
      ...
      private var var_731:HotelMergeUI;
      
      private var var_1389:CallForHelpData;
      ...
      {
         this.var_1389 = new CallForHelpData();
         this.var_2289 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1138 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_916)
         {
            this.var_916.release(new IIDHabboLocalizationManager());
            this.var_916 = null;
         }
         if(this.var_269)
         {
         ...
         if(this.var_730)
         {
            this.var_730.release(new IIDHabboConfigurationManager());
            this.var_730 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_730.getKey(param1,param2,param3);
      }
      ...
      {
         this.var_1389.reportedUserId = param1;
         this.var_1389.reportedUserName = param2;
         this.var_63.showUI(HabboHelpViewEnum.const_388);
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            this.var_63 = new HelpUI(this,this._assetLibrary,this._windowManager,this.var_916,this._toolbar);
         }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_731)
         {
            this.var_731 = new HotelMergeUI(this);
         }
         this.var_731.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_103)
         {
            this.var_103.showView(TutorialUI.const_330);
         }
      }
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1584 = new IncomingMessages(this,this.var_269);
      ...
      {
         this.var_916 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_730 = IHabboConfigurationManager(param2);
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         if(!this.var_915)
         {
            this.var_915 = new WelcomeScreenController(this,this._windowManager,this.var_730);
         }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_121,HabboToolbarIconEnum.HELP));
         }
      }
