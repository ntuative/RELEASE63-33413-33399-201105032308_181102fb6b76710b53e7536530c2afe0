package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1419:uint = 13232628;
      
      private static var var_1781:uint = 11129827;
      ...
      private var var_1163:NameSuggestionListRenderer;
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_750)
         {
            this.var_750 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_750)
            {
               return;
            }
            this._window.content.addChild(this.var_750);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_750.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_501;
         }
         this.showView(this.var_750);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_501);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_866:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1076:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1074 || param1 == ChangeUserNameResultMessageEvent.var_1076)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1163 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1163.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1419;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_501 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_501);
               break;
