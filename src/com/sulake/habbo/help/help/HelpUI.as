package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105032302));
         this._toolbar = param5;
         this.var_120 = new Map();
         this.var_120.add(HabboHelpViewEnum.const_1688,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_212,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_547,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_362,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_249,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_120.add(HabboHelpViewEnum.const_851,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_290,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_120.add(HabboHelpViewEnum.const_1226,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_120.add(HabboHelpViewEnum.const_1196,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_120.add(HabboHelpViewEnum.const_701,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_533.length == 0 || param1 != this.var_380)
            {
               this.var_533.push(this.var_380);
            }
         }
         this.var_380 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_290:
               this.showUI(HabboHelpViewEnum.const_290);
               break;
            case CallForHelpResultEnum.const_1096:
               this.showUI(HabboHelpViewEnum.const_1196);
               break;
            case CallForHelpResultEnum.const_1108:
               this.showUI(HabboHelpViewEnum.const_1226);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_120.getValue(HabboHelpViewEnum.const_212) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_544));
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2727 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2729;
         this._window.width = _loc1_.width + this.var_2727;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_380 == HabboHelpViewEnum.const_212)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_381.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_380 == HabboHelpViewEnum.const_212 || this.var_533.length == 0)
         {
            return;
         }
         if(this.var_381 == null)
         {
            ...
            this.var_381 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_381.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_381.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_381 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_381 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_381 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
