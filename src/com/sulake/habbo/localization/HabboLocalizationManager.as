package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_2018:Dictionary;
      ...
      {
         this.var_2018 = new Dictionary();
         this.var_2811 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_2017 = (param2 & 0) > 0;
         if(!this.var_2017)
         {
            lock();
         }
      ...
      {
         this.var_2018[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_2018[param1];
      }
      ...
      {
         return this.var_2811[Math.max(0,param1 - 1)];
      }
   }
}
