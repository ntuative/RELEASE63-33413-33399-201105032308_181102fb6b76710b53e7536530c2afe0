package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1045:int = 100;
      
      private static const const_1445:int = 20;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_137 = param1;
         this.var_1941 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1045 + const_1445)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1446;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_524 == null || _loc1_.id != this.var_524.id)
         {
            this.var_524 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_524.followingAllowed)
         {
            this.var_1941.enable();
         }
         else
         {
            this.var_1941.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this._list.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_524.messages.length - const_1045);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_524.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_524.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_949 || param3.type == Message.const_948 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_524.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_137.send(new FollowFriendMessageComposer(this.var_524.id));
      }
