package com.sulake.habbo.friendbar
{
   ...
   public class HabboFriendBar extends ComponentContext
   {
      ...
      private function onConfigurationAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         var _loc3_:* = this.var_176.getKey("friendbar.enabled") == "true";
         this.var_1175 = this.var_176.getKey("friend_bar.helper.friend_finding.enabled") == "true";
         var _loc4_:* = this.var_176.getKey("client.toolbar.static.enabled","false") == "true";
         if(_loc3_)
         {
