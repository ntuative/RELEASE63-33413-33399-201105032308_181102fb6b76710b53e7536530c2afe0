package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_301:Boolean = false;
      
      private static const const_669:String = "FriendBar";
      
      private static const const_668:String = "user_interaction";
      
      private static const const_1439:String = "visit_btn_click";
      
      private static const const_1440:String = "chat_btn_click";
      
      private static const const_1441:String = "find_friends_btn_click";
      
      private static const const_1044:String = "Toolbar";
      
      private static const const_1043:String = "open";
      
      private static const const_1042:String = "close";
      ...
      private var var_309:IHabboFriendList;
      
      private var var_441:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_309)
            {
               this.var_309.release(new IIDHabboFriendList());
               this.var_309 = null;
            }
            if(this.var_441)
            {
               this.var_441.release(new IIDHabboMessenger());
               this.var_441 = null;
            }
            this.var_141 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_84)
         {
            ...
            this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_669,const_668,const_1439));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_441)
         {
            this.var_441.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_84)
            {
               this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_669,const_668,const_1440));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_84)
         {
            ...
            this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_669,const_668,const_1441));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_309)
         {
            if(!this.var_309.disposed)
            {
               if(!this.var_309.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_309.openFriendRequests();
                  }
                  else
                  {
                     this.var_309.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_309.mainWindow;
               ...
               if(this.var_84)
               {
                  this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1044,const_1438,!!this.var_309.isOpen() ? const_1043 : const_1042));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_441)
         {
            if(!this.var_441.disposed)
            {
               this.var_441.toggleMessenger();
               if(this.var_84)
               {
                  this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1044,const_1442,!!this.var_441.isOpen() ? const_1043 : const_1042));
               }
            }
         }
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc6_)
         {
            ...
            else if(_loc4_.online || const_301)
            {
         ...
         {
            this.var_141 = !!const_301 ? this.sortByNameAndOnlineStatus(this.var_141) : this.sortByName(this.var_141);
         }
