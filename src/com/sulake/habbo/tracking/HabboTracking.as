package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1089:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_112:IHabboHelp;
      ...
      private var var_408:FramerateTracker = null;
      
      private var var_243:LatencyTracker = null;
      
      private var var_582:LagWarningLogger = null;
      
      private var var_583:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_408 = new FramerateTracker();
         this.var_243 = new LatencyTracker();
         this.var_582 = new LagWarningLogger();
         this.var_583 = new ToolbarClickTracker(this);
         this.var_1353 = new Array(const_986);
         var _loc4_:int = 0;
         while(_loc4_ < const_986)
         {
            this.var_1353[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1696,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1766,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1810,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_792,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1089)
            {
               this.var_1089.release(new IIDHabboWindowManager());
               this.var_1089 = null;
            }
            if(this.var_327)
            {
            ...
            if(this.var_197)
            {
               if(!this.var_197.disposed)
               {
                  ...
                  Component(this.var_197).events.removeEventListener(HabboFriendListTrackingEvent.const_424,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_112)
            {
               if(!this.var_112.disposed)
               {
                  this.var_112.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_112.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_112.release(new IIDHabboHelp());
               this.var_112 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_345,this.onRoomAction);
               }
            ...
            {
               this.var_289.stop();
               this.var_289.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_289 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_176)
         {
            if(this.var_243 != null)
            {
               this.var_243.configuration = this.var_176;
            }
            if(this.var_242 != null)
            {
               this.var_242.configuration = this.var_176;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1605);
            if(this.var_176)
            {
               if(this.var_582 != null)
               {
                  this.var_582.configure(this.var_176);
               }
               if(this.var_408 != null)
               {
                  this.var_408.configure(this.var_176);
               }
               if(this.var_583 != null)
               {
                  this.var_583.configure(this.var_176);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_772,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_487,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_582 != null)
            {
               this.var_582.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1634);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_772:
               this.trackLoginStep(HabboLoginTrackingStep.const_1775,String(this._communication.port));
               break;
      ...
      {
         this.var_1089 = IHabboWindowManager(param2);
         if(this.var_1089)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_176)
            {
               if(this.var_176.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1353)
                  {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_197).events.addEventListener(HabboFriendListTrackingEvent.const_424,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_424:
      ...
      {
         this.var_112 = param2 as IHabboHelp;
         this.var_112.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_112.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.privateRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_792,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_345,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_327 = param2 as IAdManager;
         this.var_327.events.addEventListener(AdEvent.const_580,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_343)
         {
            if(this.var_1626 < 1)
            {
               if(!this.var_289)
               {
                  this.var_289 = new Timer(60000,1);
                  this.var_289.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_289.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_345)
         {
            if(this.var_289)
            {
               this.var_289.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_408)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_408.frameRate),_loc2_);
                  ++this.var_1626;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_583)
         {
            this.var_583.track(param1.iconName);
         }
      }
      ...
      {
         this.var_582.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_481 > -1 && _loc2_ < this.var_481)
         {
            ++this.var_1625;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1625);
         }
         if(this.var_481 > -1 && _loc2_ - this.var_481 > 15000)
         {
            ++this.var_1627;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1627);
         }
         this.var_481 = _loc2_;
         if(this.var_242 != null)
         {
            this.var_242.update(param1,this.var_481);
         }
         if(this.var_243 != null)
         {
            this.var_243.update(param1,this.var_481);
         }
         if(this.var_408 != null)
         {
            this.var_408.trackUpdate(param1,this,this.var_481);
         }
         if(this.var_582 != null)
         {
            this.var_582.update(this.var_481);
         }
      }
   }
}
