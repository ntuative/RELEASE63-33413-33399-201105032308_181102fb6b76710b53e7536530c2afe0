package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_843:IssueMessageData = null;
      
      private var var_842:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2678 = param2.pickerUserId;
         this.var_2852 = param2.pickerUserName;
         this.var_1564 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_843 == null || param1.timeStamp < this.var_843.timeStamp)
         {
            this.var_843 = param1;
         }
         if(this.var_842 == null || param1.priority > this.var_842.timeStamp)
         {
            this.var_842 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_842;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_843;
         if(_loc2_ == null)
         {
