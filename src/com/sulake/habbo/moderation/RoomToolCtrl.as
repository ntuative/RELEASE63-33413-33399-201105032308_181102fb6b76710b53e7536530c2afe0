package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_523:ITextFieldWindow;
      ...
      private var var_1429:ICheckBoxWindow;
      ...
      {
         return WindowTracker.const_1569;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_523 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_523.procedure = this.onInputClick;
         this.var_1114 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1114);
         this.var_1114.procedure = this.onSelectTemplate;
         this.var_939 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1428 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1429 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_808,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_692 || this.var_523.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_939.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1576,_loc2_,this.var_523.text,"",""));
         if(this.var_1428.isSelected || this.var_1429.isSelected || this.var_939.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1428.isSelected,this.var_1429.isSelected,this.var_939.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1574);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1708);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1114.selection];
         if(_loc3_ != null)
         {
            this.var_692 = false;
            this.var_523.text = _loc3_;
         }
      }
   }
}
