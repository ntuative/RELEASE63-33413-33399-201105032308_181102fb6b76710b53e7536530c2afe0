package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_511:UserInfoCtrl;
      
      private var var_1189:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_511 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_1189 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_511.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1189.load(_loc4_,this.var_161.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_64 != null && this.var_64.issueManager != null && this.var_161 != null)
         {
            this.var_64.issueManager.removeHandler(this.var_161.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_161.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_161.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_161.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.releaseBundle(this.var_161.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_64,WindowTracker.const_1097,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_511 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
            this.var_511.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
