package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_973:Array = [];
      
      private static var var_1865:int = 1000;
      
      private static var var_974:Array = [];
      
      private static var var_1862:int = 200;
      ...
      private var var_1863:IMessageComposer;
      ...
      private var var_1864:Dictionary;
      ...
      {
         this.var_779 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_778 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_482 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1863);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_973.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1864[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1469)
         {
