package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1979:int = 200;
      ...
      {
         this.var_814 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1530)
         {
