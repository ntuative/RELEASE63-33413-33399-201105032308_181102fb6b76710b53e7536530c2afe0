package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2139:String = "my_issues";
      
      private const const_2140:String = "open_issues";
      
      private const const_2141:String = "picked_issues";
      
      private const const_2179:String = "closed_issues";
      ...
      private var var_1826:IIssueBrowserView;
      
      private var var_1825:IIssueBrowserView;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2139:
               if(this.var_1826 == null)
               {
                  this.var_1826 = new MyIssuesView(this.issueManager,this,this.var_259.container);
               }
               return this.var_1826;
            case this.const_2140:
               if(this.var_1825 == null)
               {
                  this.var_1825 = new OpenIssuesView(this.issueManager,this,this.var_259.container);
               }
               return this.var_1825;
            case this.const_2141:
               if(this.var_1824 == null)
               {
                  this.var_1824 = new PickedIssuesView(this.issueManager,this,this.var_259.container);
               }
