package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2849 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2850 = int(this._config.getKey("interstitial.interval","30000"));
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1581 = _loc2_.imageUrl;
         this.var_2848 = _loc2_.clickUrl;
         this.var_1293 = getTimer();
         if(this.var_1581 != "")
         {
            _loc3_ = this.var_1581;
            ...
            {
               this.var_237 = new Timer(this.var_2847,1);
            ...
            this.var_237.start();
            _loc4_ = new URLRequest(this.var_1581);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_521,0,0,param1.bitmapData,this.var_2848));
            this.var_1293 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_537));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1582 = _loc2_.imageUrl;
         this.var_2045 = _loc2_.clickUrl;
         if(this.var_1582 != "" && this.var_2045 != "")
         {
            _loc3_ = this.var_1582;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1582);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_580,0,0,_loc4_,_loc2_.assetName,this.var_2045,this.var_1294,this.var_1295));
         }
      }
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_745,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_932,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
