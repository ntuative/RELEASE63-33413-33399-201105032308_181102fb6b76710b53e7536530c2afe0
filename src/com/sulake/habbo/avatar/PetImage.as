package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_652:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_652 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_652.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1574 = this.var_1191;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1574);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_652,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1574 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_99)
               {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_652,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_99)
               {
                  _loc17_ = 6;
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_520 = this.var_520 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_414:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1621:
                  case AvatarAction.const_1768:
                  case AvatarAction.const_1748:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1038);
         this.getCache().resetBodyPartCache(this.var_1038);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1573 = this._structure.sortActions(this.var_332);
         ...
         {
            this.var_839 = this._structure.getCanvasOffsets(this.var_1573,this._scale,this.var_88);
         }
      }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1191 = _loc4_.id;
                     this.var_1837 = _loc4_.breed;
                     break;
                  }
               }
            }
