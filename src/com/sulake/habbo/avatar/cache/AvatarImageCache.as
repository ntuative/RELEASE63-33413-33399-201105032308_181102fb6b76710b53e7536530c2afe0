package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1876:int = 60000;
      ...
      private var var_2453:ByteArray;
      
      private var var_2451:ImageData;
      
      private var var_1014:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_761 == GeometryType.const_1183 && param1 == GeometryType.const_1201 || this.var_761 == GeometryType.const_1201 && param1 == GeometryType.const_1183)
         {
            this.var_761 = param1;
            this.var_83 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_357.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_882)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_503)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1367.getFigure(),_loc5_,this.var_761,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_461 == null)
         {
            ...
            this.var_461 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_357);
            if(this.var_461 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_83)
         {
            this.var_83 = this._structure.getCanvas(this._scale,this.var_761);
            if(!this.var_83)
            {
               return null;
            }
            this.var_2452 = new Point(0,this.var_83.height - int(this.var_83.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1811[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_788 || _loc10_ == AvatarAction.const_440;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1437 = this.var_117.bodyPartId;
               this.var_184 = this.var_117.partType;
               this.var_1811 = this.var_117.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_117.flippedPartType != this.var_184)
                     {
                        this.var_184 = this.var_117.flippedPartType;
                     }
                  }
               }
               this.var_1438 = this._scale + "_" + this.var_117.action.assetPartDefinition + "_" + this.var_184 + "_" + this.var_1811 + "_" + _loc5_ + "_" + this._frame;
               this.var_434 = this._assets.getAssetByName(this.var_1438) as BitmapDataAsset;
               if(this.var_434 == null)
               {
                  this.var_1438 = this._scale + "_std_" + this.var_184 + "_" + this.var_1811 + "_" + _loc5_ + "_0";
                  this.var_434 = this._assets.getAssetByName(this.var_1438) as BitmapDataAsset;
               }
               if(!(!this.var_434 || !this.var_434.content))
               {
                  ...
                  {
                     this.var_1014 = this._structure.renderManager.paletteManager.getPalette(this.var_117.paletteMapId);
                     if(this.var_1014 != null)
                     {
                        this.var_949 = this.var_434.content as BitmapData;
                        this.var_185 = new BitmapData(this.var_949.width,this.var_949.height);
                        this.var_2453 = this.var_1014.colorize(this.var_949.getPixels(this.var_949.rect));
                        this.var_185.setPixels(this.var_185.rect,this.var_2453);
                     }
                     else
                     {
                        this.var_185 = (this.var_434.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1437 == AvatarBodyPartType.const_297 || this.var_1437 == AvatarBodyPartType.const_1627 || this.var_1437 == AvatarBodyPartType.const_1805) && this.var_117.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_185.colorTransform(this.var_185.rect,this.var_117.color.colorTransform);
                  }
                  if(this.var_117.isBlendable)
                  {
                     this.var_185.colorTransform(this.var_185.rect,this.var_117.blendTransform);
                  }
                  this.var_950 = this.var_434.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_56)
                     {
                  ...
                  this.var_2451 = new ImageData(this.var_185,this.var_950,_loc7_);
                  this.var_948.push(this.var_2451);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_948,_loc6_);
         ...
         _loc8_ = this.var_948.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_948.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
