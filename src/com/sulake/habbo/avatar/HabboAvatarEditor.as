package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1454:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1456:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1523:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_1003 = FigureData.const_77;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            this.var_665["null"] = new FigureData(this);
            _loc2_ = this.var_665["null"];
            _loc3_ = this.var_665["null"];
            _loc2_.loadAvatarData(const_1454,FigureData.const_77);
            _loc3_.loadAvatarData(const_1456,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_535 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_795,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_297,new TorsoModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_848,new LegsModel(this));
            ...
            this.var_535.add(AvatarEditorSideCategory.const_115,new WardrobeModel(this));
            this.var_535.add(AvatarEditorSideCategory.const_549,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_665[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_267 == null)
            {
               this.var_267 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_67,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_795);
         }
      ...
      {
         this.var_1006 = this.var_536.getFigureData(AvatarType.const_126);
      ...
      {
         return this.var_665[this.var_1003];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1523 != null)
         {
            ...
            this.var_1523.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1963;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1246 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1455)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1613.clone() as IWindowContainer,param1,_loc13_);
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1325.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1823)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1246 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1325.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1246 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_535.getValue(AvatarEditorSideCategory.const_115);
      }
