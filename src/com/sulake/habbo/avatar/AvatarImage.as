package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1414:String = "Default";
      ...
      protected var var_652:AvatarFigureContainer;
      ...
      private var var_1038:IActiveActionData;
      ...
      private var var_2587:String = null;
      
      private var var_2586:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1415,const_1416);
         this.var_332 = new Array();
         this.var_1038 = new ActiveActionData(AvatarAction.const_374);
         this.var_1038.definition = this._structure.getActionDefinition(const_1414);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_652,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1887;
         if(param2 < AvatarDirectionAngle.const_1143)
         {
            param2 = AvatarDirectionAngle.const_302 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_302)
         {
            param2 -= NaN;
         }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_264.length == 1 && this.var_88 == this.var_2053)
         {
            return this.var_88 + this.var_520 + this.var_635 % 4;
         }
         if(this.var_264.length == 2)
         {
            for each(_loc1_ in this.var_264)
            {
               ...
               {
                  return this.var_88 + this.var_520 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_635 % 11;
                  return this.var_88 + "_" + this.var_2053 + this.var_520 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2585 || param2 != this.var_2587 || param1 != this.var_2586)
         {
            this.var_2585 = param3;
            this.var_2587 = param2;
            this.var_2586 = param1;
            this.var_1888 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_332.push(new ActiveActionData(param1,param2,this.var_635));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_1038;
         this.var_287.definition = this.var_1038.definition;
         this.resetBodyPartCache(this.var_1038);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_520 = "";
         this.var_264 = this._structure.sortActions(this.var_332);
         if(this.var_264 == null)
         {
            this.var_839 = new Array(0,0,0);
            if(this.var_1483 != "")
            {
               _loc1_ = true;
               this.var_1483 = "";
         ...
         {
            this.var_839 = this._structure.getCanvasOffsets(this.var_264,this._scale,this.var_88);
            for each(_loc4_ in this.var_264)
            {
               this.var_520 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_355)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1484 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1484 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1483 != this.var_520)
            {
               _loc1_ = true;
               this.var_1483 = this.var_520;
            }
         }
         this.var_1485 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_264)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_936 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_208 = this.var_208.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1887 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_337 || _loc1_.actionType == AvatarAction.const_277 || _loc1_.actionType == AvatarAction.const_440)
               {
                  this.var_936 = true;
               }
            }
