package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1613:IWindowContainer;
      
      public static var var_2108:int = 6710886;
      ...
      private var var_343:ITabSelectorWindow;
      ...
      private var var_2258:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1123 = [];
         this.var_1383 = [AvatarEditorFigureCategory.const_795,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_297,AvatarEditorFigureCategory.const_848,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_115];
         super();
         ...
         if(var_1325 == null)
         {
            ...
            var_1325 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1613 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1613 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1123.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1123.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2258 = this.canChangeOutfit();
            this.var_421.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_343 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_343.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_343.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1123.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_343.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_343.numSelectables)
               {
                  this.var_343.getSelectableAt(_loc6_).x = this.var_343.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_343.setSelected(this.var_343.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1697 == AvatarEditorSideCategory.const_115 || this.var_2259))
         {
      ...
      {
         if(this.var_1697 == AvatarEditorSideCategory.const_115)
         {
            this.var_2259 = false;
            this.setSideContent(AvatarEditorSideCategory.const_746);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_746:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_380 = param1;
         this.var_343.setSelected(this.var_343.getSelectableByName(param1));
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_489)
         {
            ...
            this.var_489 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_489.procedure = this.stripClubDialogEventProc;
            this.var_489.center();
         }
         else
         {
