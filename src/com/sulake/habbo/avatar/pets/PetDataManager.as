package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager, IDisposable
   {
      ...
      {
         if(param1 == null || this.var_509 == null)
         {
            return;
         }
      ...
      private function notifyListeners() : void
      {
         ...
         {
            _loc1_ = this.var_509.pop() as IPetDataListener;
            ...
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.PetCommandsMessageParser.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         if(param2 == AvatarScaleType.const_99)
         {
            _loc5_ = 0;
         ...
         {
            if(this.var_1451.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_629.getValue(_loc6_) == null)
               {
                  ...
                  this.var_629.add(_loc6_,_loc8_);
                  if(param3 != null && this.var_509.indexOf(param3) == -1)
                  {
                     this.var_509.push(param3);
                  }
               }
            }
         }
      ...
      private function unregisterLoadingAssets(param1:LibraryLoader) : void
      {
         ...
         for each(_loc3_ in this.var_629.getKeys())
         {
            _loc5_ = this.var_629.getValue(_loc3_);
            if(param1 == _loc5_)
            {
               _loc2_.push(_loc3_);
            }
