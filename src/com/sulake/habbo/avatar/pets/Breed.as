package com.sulake.habbo.avatar.pets
{
   public class Breed extends PetEditorInfo implements IBreed
   {
      ...
      private var var_2537:Boolean = true;
      ...
      public function Breed(param1:XML)
      {
         ...
         this.var_2538 = parseInt(param1.@pattern);
         this.var_1003 = String(param1.@gender);
         this.var_1501 = Boolean(parseInt(param1.@colorable));
         this.var_2437 = String(param1.@localizationKey);
