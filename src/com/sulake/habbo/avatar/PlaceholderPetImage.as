package com.sulake.habbo.avatar
{
   ...
   public class PlaceholderPetImage extends PetImage
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_693)
         {
            for each(_loc1_ in this.var_693)
            {
            }
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = this.var_693.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            this.var_693.add(_loc3_,_loc4_.clone());
            _loc4_ = this.var_693.getValue(_loc3_);
         }
         return _loc4_;
      }
