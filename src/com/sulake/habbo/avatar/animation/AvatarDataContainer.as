package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_837 = new ColorTransform(this.var_1860,this.var_1859,this.var_1861,this._alphaMultiplier);
         this.var_1314 = this.generatePaletteMapForGrayscale(this.var_2887,this.var_2889);
      }
      ...
      {
         return this.var_1314.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1314.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1314.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1314.getValue("alphas") as Array;
      }
