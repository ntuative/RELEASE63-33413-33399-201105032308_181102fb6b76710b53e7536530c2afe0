package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2122:String = "hd-99999-99999";
      ...
      private var var_298:PetDataManager;
      
      private var var_741:PaletteManager;
      ...
      private var var_1756:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_571 = RenderMode.const_1743;
         ...
         this.var_104.add(AvatarType.const_126,_loc4_);
         ...
         this.var_104.add(AvatarType.const_72,_loc4_);
         this._aliasCollection = new AssetAliasCollection(this,param1.assets as AssetLibraryCollection);
         this.var_298 = new PetDataManager(this,param1.assets as AssetLibraryCollection);
         this.var_741 = new PaletteManager(param1.assets as AssetLibraryCollection);
         var _loc5_:XML = param3.getAssetByName("HabboAvatarPetFigure").content as XML;
         this.var_298.populateFigureData(_loc5_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_298.init();
         this.var_741.init();
         _loc2_ = this.var_104.getValue(AvatarType.const_126) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_104.getValue(AvatarType.const_72) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_104.getValue(AvatarType.const_126) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_911)
         {
            if(this.var_2365 && this.var_2364 && this.var_2366)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_104.getValue(AvatarType.const_126) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1756)
         {
            this.var_1756 = new AvatarFigureContainer(this.const_2122);
         }
         this.var_221.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1756,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_299 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_299.getKeys())
         {
            _loc4_ = this.var_299.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_298.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1566)
         {
            _loc6_ = !this.var_298.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_298.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_104.getValue(AvatarType.const_72) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_299.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         this.var_298.populateFigureData(_loc1_);
         var _loc2_:AvatarStructure = this.var_104.getValue(AvatarType.const_72);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_299.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_299.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_104.getValue(AvatarType.const_126) as AvatarStructure;
      ...
      {
         return this.var_298 as IPetDataManager;
      }
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_72:
               _loc3_ = this.var_104.getValue(AvatarType.const_72) as AvatarStructure;
               break;
            default:
