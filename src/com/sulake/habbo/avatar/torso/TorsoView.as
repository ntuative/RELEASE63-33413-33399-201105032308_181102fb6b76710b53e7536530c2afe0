   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_262,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_202,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_67,FigureData.const_283,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_67 && var_149 == "")
         {
            var_67.switchCategory(FigureData.const_202);
         }
      }
