package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_627 = _loc4_.content as BitmapData;
         ...
         this.var_904 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_627.width,this.var_627.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_627,this.var_627.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_953.width,this.var_953.height,true,0);
            _loc5_ = this.var_953.clone();
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_904.width,this.var_904.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_904,this.var_904.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_903)
            {
               switch(this.var_903.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_46:
                     _loc4_.style = HabboIconType.const_943;
                     _loc4_.visible = true;
               }
            }
            else
