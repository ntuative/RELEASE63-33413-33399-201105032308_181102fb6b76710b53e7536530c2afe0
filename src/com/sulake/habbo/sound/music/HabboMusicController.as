package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1519:int = HabboMusicPrioritiesEnum.const_120;
      ...
      private var var_559:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_713.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_713.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_713)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_933,this.onJukeboxInit);
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_285,this.onJukeboxDispose);
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_980,this.onSoundMachineInit);
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_718,this.onSoundMachineDispose);
         ...
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_291)
         {
            this.var_560[_loc6_] = null;
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2067)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_401)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_78)
            {
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_933,this.onJukeboxInit);
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_285,this.onJukeboxDispose);
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_980,this.onSoundMachineInit);
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_718,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_560[param1];
      ...
      {
         var _loc1_:int = this.var_560.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_560[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_291)
         {
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_291)
         {
            return false;
         }
         ...
         this.var_2067 = this.getSongRequestCountAtPriority(param1);
         this.var_2066 = param2;
         if(this._priorityPlaying <= const_1519)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2880 != param1.id || _loc3_ > this.var_2879 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2880 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_559 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_78,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_559 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
