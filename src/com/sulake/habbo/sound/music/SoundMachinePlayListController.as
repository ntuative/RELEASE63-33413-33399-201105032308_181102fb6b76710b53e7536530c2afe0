package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_231 = param2;
         this.var_713 = [];
         this.var_713.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_713.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_713)
         {
         ...
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_865,this.onSoundMachinePlayEvent);
         this.var_78.addEventListener(RoomEngineSoundMachineEvent.const_918,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_78)
            {
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_865,this.onSoundMachinePlayEvent);
               this.var_78.removeEventListener(RoomEngineSoundMachineEvent.const_918,this.onSoundMachineStopEvent);
               this.var_78 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_445);
      ...
      public function stopPlaying() : void
      {
         this.var_445 = -1;
         this.var_668 = false;
         this.var_231.stop(HabboMusicPrioritiesEnum.const_120);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_231.playSong(param1,HabboMusicPrioritiesEnum.const_120,_loc3_,0,0,0))
         {
