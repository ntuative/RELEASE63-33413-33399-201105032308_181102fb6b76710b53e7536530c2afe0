package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1523:int = 5;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_712 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_712.toggle();
         this.var_2075 = false;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1523;
