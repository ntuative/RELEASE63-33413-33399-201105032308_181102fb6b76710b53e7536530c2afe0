package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1861:int = 2;
      
      private const const_1862:int = 3;
      
      private const const_1864:int = 4;
      
      private const const_2124:int = 0;
      
      private const const_2125:int = 1;
      
      private const const_2131:int = 2;
      
      private const const_2126:int = 3;
      
      private const const_2127:int = 4;
      
      private const const_2123:int = 5;
      
      private const const_1863:String = "deco_img";
      
      private const const_1858:String = "dialog_bg";
      
      private const const_2129:String = "%campaign%_dialog_bg.png";
      
      private const const_368:String = "%campaign%_gift_package.png";
      
      private const const_2128:String = "%campaign%_gift_content.png";
      
      private const const_2130:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1408 = this.var_132.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1408 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1409.length)
         {
            _loc2_ = this.var_1409.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_132 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_602,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_602,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_602:
               _loc2_ = this.const_1860;
               this._shareId = null;
               break;
         ...
         if(this._window && (this.var_1410 != _loc2_ || _loc3_ != this.var_182))
         {
            this._window.dispose();
            this._window = null;
         }
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1410)
            {
               case this.const_1860:
                  ...
                  break;
               case this.const_1859:
                  if(this.var_403 == this.const_2124)
                  {
                  ...
                  else if(this.var_403 == this.const_2125)
                  {
                     ...
                     _loc2_ = this.const_2128;
                  }
                  else if(this.var_403 == this.const_2131)
                  {
                  ...
                  else if(this.var_403 == this.const_2126)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_403 == this.const_2127)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_182,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_403 == this.const_2123)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2129.replace("%campaign%",this.var_182);
            this.setDecoImage(_loc5_,this.const_1858);
            _loc2_ = _loc2_.replace("%campaign%",this.var_182);
            this.setDecoImage(_loc2_,this.const_1863);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_823);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_190);
         ...
         if(this._inventory)
         {
            if(this.var_1407 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1407 == 1 ? "null" : InventoryCategory.const_148);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_916,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1409.push(new ImageDownloader(this,_assets,this.var_182,this.var_1408,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_1858:
            case this.const_1863:
