package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_676:String = "welcome_gift_email_unverified";
      
      private const const_1060:String = "welcome_gift_email_verified";
      
      private const const_1484:String = "welcome_gift_email_change";
      
      private const const_2172:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         {
            this.setViewState(this.const_676);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_676:
               ...
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1025);
               break;
      ...
      {
         this.setViewState(this.const_1484);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_971,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1265 ? this.const_1060 : this.const_676);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1546 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1546));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_474,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_835,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_474,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_835,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_474:
               this.var_1545 = param1.email;
               this.var_1265 = param1.isVerified;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1545 = this.var_1546;
            this.setViewState(this.const_676);
         }
         else
         {
            if(param1.result == this.const_2172)
            {
               this.var_1025 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1546);
