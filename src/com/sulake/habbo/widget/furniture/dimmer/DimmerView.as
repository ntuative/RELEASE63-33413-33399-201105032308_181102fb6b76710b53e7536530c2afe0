package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_679:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_67,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1347,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_679 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1559 = _loc2_.light;
         if(this.var_458 != null)
         {
            this.var_458.setValue(this.var_1559);
         }
         this.var_526 = this.colors.indexOf(_loc2_.color);
         if(this.var_679 != null)
         {
            this.var_679.setSelectedColorIndex(this.var_526);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1558 = XML(_loc1_.content);
         return this.var_1558;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_679 != null)
         {
            this.var_679.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
