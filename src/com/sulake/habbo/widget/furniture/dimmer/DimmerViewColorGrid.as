package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1982) as IWindowContainer;
            ...
            _loc3_.width = this.var_669.width;
            _loc3_.height = this.var_669.height;
            this.var_540.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_669.width,this.var_669.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_669,this.var_669.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1255.width,this.var_1255.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1015.width,this.var_1015.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1015,this.var_1015.rect,new Point(0,0),null,null,true);
