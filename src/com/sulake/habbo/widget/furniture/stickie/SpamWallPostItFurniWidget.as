package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         var_2137 = "spamwall_postit_container";
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_501,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_501,this.onEditPostItRequest);
      }
      ...
      private function onEditPostItRequest(param1:RoomWidgetSpamWallPostItEditEvent) : void
      {
         ...
         if(_loc2_ != null && this._roomEngine != null)
         {
            ...
            var_869 = !!_loc3_.match("vd") ? "post_it_vd" : "post_it";
         }
         else
         {
            var_869 = "post_it";
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_195 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_924,var_195,this.var_416,_text,var_331);
