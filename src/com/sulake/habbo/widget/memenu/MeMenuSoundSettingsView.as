package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1045:MeMenuSoundSettingsSlider;
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_1045 != null)
         {
            this.var_1045.setValue(this.var_546);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_1045 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_909));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_2039);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_2040);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_2038);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_2041);
         }
      }
