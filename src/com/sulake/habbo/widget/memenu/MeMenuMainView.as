      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1231);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_721);
               break;
            case "rooms":
            ...
            case "clothes":
               ...
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1161));
               this._widget.hide();
               break;
            case "settings":
