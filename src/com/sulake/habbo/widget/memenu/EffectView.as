package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2156:int = 1000;
      ...
      private var var_990:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_209 = new Timer(this.const_2156);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_187.isActive)
         {
            ...
            this.var_989.width = _loc2_ * this.var_291;
         }
         else
         {
            this.var_989.width = 0;
            this.var_209.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_794 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_794 == null)
            {
               return;
            }
         ...
         if(!this.var_187.isActive)
         {
            this.var_794.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_794.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_794.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_990 = this._window.findChildByName("effect_hilite");
            this.var_990.visible = false;
         }
         this.setTimeLeft();
         this.var_989 = this._window.findChildByName("loader_bar");
         if(this.var_989 != null)
         {
            this.var_291 = this.var_989.width;
            this.var_209.start();
            this.onUpdate();
         }
