package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1780:String = "POLL_OFFER_STATE_OK";
      
      public static const const_813:String = "POLL_OFFER_STATE_CANCEL";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  ...
                  case "poll_offer_button_cancel":
                     this._state = const_813;
                     this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_640,this._id));
