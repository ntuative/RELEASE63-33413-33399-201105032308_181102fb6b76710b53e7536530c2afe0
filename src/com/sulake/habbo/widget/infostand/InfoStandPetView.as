package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2150:int = 152;
      
      private const const_2151:int = 16;
      
      private const const_1425:int = 4;
      
      private const const_2153:uint = 14342874;
      
      private const const_2152:uint = 3815994;
      
      private const const_2155:uint = 2085362;
      
      private const const_2143:uint = 39616;
      
      private const const_2146:uint = 10513106;
      
      private const const_2144:uint = 8734654;
      
      private const const_2149:uint = 9094430;
      
      private const const_2148:uint = 6200576;
      
      private const const_2145:String = "happiness";
      
      private const const_2154:String = "experience";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2145,param1.nutrition,param1.nutritionMax,this.const_2143,this.const_2155);
         this.updateStateElement(this.const_2154,param1.experience,param1.experienceMax,this.const_2144,this.const_2146);
         this.updateStateElement(this.const_2147,param1.energy,param1.energyMax,this.const_2148,this.const_2149);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2150,this.const_2151,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2153);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2152);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1425,_loc7_.width - 2,_loc7_.height - 2 - this.const_1425);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1425);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_496) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_207 && this.var_207.getPetId() == this.var_496)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1602,true);
