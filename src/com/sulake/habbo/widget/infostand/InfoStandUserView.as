package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1227:TagListRenderer;
      ...
      private const const_1889:int = 7829367;
      
      private const const_1888:int = 16777215;
      
      private const const_2168:int = 2000;
      
      private const const_2169:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1227 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2744 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1889;
            }
            else
            {
               _loc3_.textColor = this.const_1888;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1051,this.const_2169);
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1227.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_133);
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_761:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2745 > this.const_2168 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2745 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1889;
         }
      }
