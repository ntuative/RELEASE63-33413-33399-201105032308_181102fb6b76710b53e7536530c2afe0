package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2138:int = 5;
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            this._offsetX = 0;
            this.var_1182 += param1.height + this.const_2137;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1182);
         this._offsetX += param1.width + this.const_2138;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1445 != null && this.var_1445.indexOf(param1) != -1)
         {
