package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1871:String = "infostand_user_view";
      
      private const const_1872:String = "infostand_furni_view";
      
      private const const_1875:String = "infostand_pet_view";
      
      private const const_1873:String = "infostand_bot_view";
      
      private const const_1874:String = "infostand_jukebox_view";
      ...
      private var var_942:InfoStandJukeboxView;
      
      private var var_941:InfoStandSongDiskView;
      
      private var var_2439:Array;
      
      private var var_1433:InfostandUserData;
      
      private var var_594:InfostandFurniData;
      ...
      private const const_2134:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1169 = new InfoStandFurniView(this,this.const_1872,this._catalog);
         this.var_183 = new InfoStandUserView(this,this.const_1871);
         this.var_355 = new InfoStandPetView(this,this.const_1875,this._catalog);
         this.var_433 = new InfoStandBotView(this,this.const_1873);
         this.var_942 = new InfoStandJukeboxView(this,this.const_1874,this._catalog);
         this.var_941 = new InfoStandSongDiskView(this,this.const_1870,this._catalog);
         this.var_1433 = new InfostandUserData();
         this.var_594 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_159 = new Timer(this.const_2134);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_67,HabboWindowStyle.const_44,HabboWindowParam.const_44,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_421,this.var_355.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         if(this.var_1805)
         {
            ...
            this.selectView(this.const_1871);
            if(this.var_159)
            {
               this.var_159.stop();
            }
      ...
      private function onBotInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1873);
         if(this.var_159)
         {
            this.var_159.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_727)
         {
            this.var_942.update(param1);
            this.selectView(this.const_1874);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_383) != -1)
         {
            this.var_941.update(param1);
            this.selectView(this.const_1870);
         }
         else
         {
            this.var_1169.update(param1);
            this.selectView(this.const_1872);
         }
         if(this.var_159)
         {
            this.var_159.stop();
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1875);
         if(this.var_159)
         {
            this.var_159.start();
         }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_183.setTags(param1.tags,this.var_2439);
         }
      }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_353,param1.id,param1.category);
      ...
      private function onSongUpdate(param1:RoomWidgetSongUpdateEvent) : void
      {
         ...
         this.var_941.updateSongInfo(param1);
      }
