package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_425)
         {
            this.var_1886 = param1.songId;
         }
         if(param1.songId == this.var_1886)
         {
            this._songName = param1.songName;
            this.var_2584 = param1.songAuthor;
            this.updateNowPlaying(this.var_1886 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2584;
         }
         else
         {
