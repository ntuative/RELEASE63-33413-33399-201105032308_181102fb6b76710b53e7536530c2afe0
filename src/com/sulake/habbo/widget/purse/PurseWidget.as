package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_2158:uint = 4.291993382E9;
      
      private const const_2160:uint = 4.29080704E9;
      
      private const const_2159:uint = 4.285767869E9;
      
      private const const_2157:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1886;
            this._view.y = this.const_1886;
      ...
      {
         this.var_1947 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1947.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1947.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1948 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1948.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1948.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1248));
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1160));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2160;
      }
