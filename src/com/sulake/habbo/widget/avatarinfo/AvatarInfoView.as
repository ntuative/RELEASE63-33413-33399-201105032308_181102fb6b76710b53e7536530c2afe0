package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1464:int = 25;
      ...
      protected var var_1346:XML;
      
      protected var var_1347:Boolean;
      
      protected var var_2146:FixedSizeStack;
      
      protected var var_2147:int = -1000000;
      ...
      {
         this.var_2146 = new FixedSizeStack(const_1464);
         super();
         this._widget = param1;
         this._userId = param2;
         ...
         this.var_2791 = param6;
         this.var_1346 = XmlAsset(this._widget.assets.getAssetByName("avatar_info_widget")).content as XML;
      }
      ...
      protected function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.buildFromXML(this.var_1346,0) as IWindowContainer;
         if(!this._window)
         {
            return;
         }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_944));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1347)
         {
            ...
            if(this.var_1620 == RoomObjectTypeEnum.const_144 || this.var_1620 == RoomObjectTypeEnum.const_484)
            {
            ...
            this.var_2146.addValue(_loc5_);
            _loc6_ = this.var_2146.getMax();
            if(_loc6_ < this.var_2147 - const_1054)
            {
               _loc6_ = this.var_2147 - const_1054;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2147 = _loc6_;
