package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      private static const const_1389:uint = 4282663229;
      
      private static const const_1388:uint = 4283715916;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_571:uint = 1;
      ...
      public function AvatarMenuView(param1:AvatarInfoWidget, param2:int, param3:String, param4:int, param5:int, param6:AvatarInfoData)
      {
         ...
         this._data = param6;
         var_1346 = XmlAsset(_widget.assets.getAssetByName("avatar_menu_widget")).content as XML;
      }
      ...
      override protected function createWindow() : void
      {
         ...
         _window = _widget.windowManager.buildFromXML(var_1346,0) as IWindowContainer;
         if(!_window)
         {
            return;
         }
      ...
      protected function updateButtons() : void
      {
         ...
         if(this.var_571 == const_1317 || this.var_571 == const_448)
         {
            ...
            else
            {
               ...
               this.var_571 = const_448;
            }
         }
         if(this.var_571 == const_448)
         {
