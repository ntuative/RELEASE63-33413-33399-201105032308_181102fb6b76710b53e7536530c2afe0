package com.sulake.habbo.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_1841:String = "button_ok";
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.center();
         dialog.findChildByName(const_1841).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
