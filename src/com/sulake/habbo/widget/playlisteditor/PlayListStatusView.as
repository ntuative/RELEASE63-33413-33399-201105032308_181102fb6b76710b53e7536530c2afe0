package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_1223:String = "PLSV_START_PLAYBACK";
      
      public static const const_483:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_44 != const_483)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_463[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_463[const_786];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_463.add(const_483,_loc1_);
