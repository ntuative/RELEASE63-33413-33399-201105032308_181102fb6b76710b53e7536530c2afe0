package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1480:int = 130;
      
      private static const const_1483:int = 100;
      
      private static const const_1478:int = 130;
      
      private static const const_1479:int = 100;
      
      private static const const_1482:int = 130;
      
      private static const const_1481:int = 100;
      ...
      {
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_885,this.onShowPlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_934,this.onHidePlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_759,this.onInventoryUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_859,this.onSongDiskInventoryUpdatedEvent);
      ...
      {
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_885,this.onShowPlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_934,this.onHidePlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_759,this.onInventoryUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_859,this.onSongDiskInventoryUpdatedEvent);
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1483 + const_1480);
         _loc3_ = uint(_loc3_ % const_1479 + const_1478);
         _loc4_ = uint(_loc4_ % const_1481 + const_1482);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_765,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_872,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         var _loc2_:RoomWidgetPlayListPlayStateMessage = new RoomWidgetPlayListPlayStateMessage(RoomWidgetPlayListPlayStateMessage.const_740,this._furniId,_loc1_);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc2_);
         }
      ...
      public function playUserSong(param1:int) : void
      {
         ...
         this._soundManager.musicController.playSong(param1,HabboMusicPrioritiesEnum.const_401,0,0,0,0);
      }
      
      public function stopUserSong() : void
      {
         this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_401);
      }
      ...
      {
         var _loc2_:String = this.var_176.getKey("image.library.playlist.url");
      ...
      public function openSongDiskShopCataloguePage() : void
      {
         ...
         this._catalog.openCatalogPage(CatalogPageName.const_1639,true);
      }
