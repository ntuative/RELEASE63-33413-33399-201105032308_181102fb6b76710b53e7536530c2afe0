package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListEditorItem
   {
      ...
      public static const const_1278:String = "PLEI_ICON_STATE_PLAYING";
      
      private static const const_1387:uint = 14283002;
      ...
      private function createWindow() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_2471 = _loc3_.getChildByName("button_remove_from_playlist") as IContainerButtonWindow;
            }
         }
      }
