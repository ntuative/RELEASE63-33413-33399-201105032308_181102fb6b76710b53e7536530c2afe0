package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_791:String = "MISV_BUY_MORE";
      
      public static const const_814:String = "MISV_PREVIEW_PLAYING";
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1726.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_814,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_791,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_463.add(const_814,_loc1_);
            this.var_1725 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1726 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_463.add(const_791,_loc1_);
