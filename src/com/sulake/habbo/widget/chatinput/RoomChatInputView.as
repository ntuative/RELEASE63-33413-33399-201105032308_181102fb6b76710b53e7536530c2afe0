package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private const const_2163:int = 250;
      
      private const const_2164:int = 0;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1122 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2253 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this.var_1954.caption = this.const_2162;
         ...
         this.var_24.addEventListener(WindowKeyboardEvent.const_187,this.windowKeyEventProcessor);
         this.var_24.addEventListener(WindowKeyboardEvent.const_328,this.keyUpHandler);
         ...
         this.var_1517 = true;
         this.var_488 = "";
         this._window.addEventListener(WindowEvent.const_820,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_627,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2163 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),this.const_2164);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_24 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1122 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_24.text = "";
                  this.var_488 = "";
               }
      ...
      private function setButtonPressedState(param1:Boolean) : void
      {
         if(this._button)
         {
            this._button.method_1(WindowState.const_93,param1);
         }
      }
