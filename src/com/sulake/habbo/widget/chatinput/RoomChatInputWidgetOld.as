package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidgetOld extends RoomWidgetBase
   {
      ...
      {
         return getTimer() - this.var_2756 > const_1462;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2756 = getTimer();
      }
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_546,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFloodControlEvent.const_386,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_386,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_743:
               _loc2_ = localizations.getKey("widgets.chatinput.mode.whisper",":tell");
               this._visualization.displaySpecialChatMessage(_loc2_,param1.userName);
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1224:
         }
      }
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_912,this._visualization.window);
         if(messageListener != null)
         {
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            this.var_815 = this.var_815 - 1;
            this._visualization.showFloodBlocking(this.var_815);
         }
      }
      ...
      {
         this.var_1531 = true;
         this.var_815 = param1.seconds;
         Logger.log("Enabling flood blocking for " + this.var_815 + " seconds");
         if(this.var_446)
         {
            this.var_446.reset();
         }
         ...
         {
            this.var_446 = new Timer(1000,this.var_815);
