package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1431:int = 128;
      
      private var var_1432:Boolean = false;
      
      private var var_2952:Point;
      ...
      {
         if(this.var_1431 > 255 || bitmapData == null)
         {
            return false;
         }
         if(param1 < 0 || param2 < 0 || param1 >= this.var_277 || param2 >= this._height)
         {
            return false;
         }
