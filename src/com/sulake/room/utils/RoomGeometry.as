package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      private var var_415:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1120 = new Vector3d();
         this.var_416 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1121 = new Vector3d();
         this.var_1688 = 1;
         this.var_1689 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1690 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_416.assign(this.var_89);
         this.var_416.x *= this.var_415;
         this.var_416.y *= this.var_414;
         this.var_416.z *= this.var_418;
         return this.var_416;
      }
      ...
      {
         if(this.var_415 != param1 * this.var_1688)
         {
            this.var_415 = param1 * this.var_1688;
            ++this.var_151;
         }
      }
      ...
      {
         if(this.var_414 != param1 * this.var_1689)
         {
            this.var_414 = param1 * this.var_1689;
            ++this.var_151;
         }
      }
      ...
      {
         if(this.var_418 != param1 * this.var_1690)
         {
            this.var_418 = param1 * this.var_1690;
            ++this.var_151;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_89.x /= this.var_415;
         this.var_89.y /= this.var_414;
         this.var_89.z /= this.var_418;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1120.assign(this.var_164);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1121.assign(_loc22_);
         }
         else
         {
            this.var_1121.assign(_loc17_);
         }
         ++this.var_151;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_415;
         _loc2_.y *= this.var_414;
         _loc2_.z *= this.var_418;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1121);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_414;
            _loc2_.z *= this.var_418;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1121);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_89.x * this.var_415,this.var_89.y * this.var_414,this.var_89.z * this.var_418);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_164;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_415,param2.y * this.var_414,param2.z * this.var_418);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_415,param3.y * this.var_414,param3.z * this.var_418);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_415,param4.y * this.var_414,param4.z * this.var_418);
